 ...
 * @package         kernel
 * @subpackage      Xoops Object
 * @since           2.0.0
 * @author Kazumi Ono (AKA onokazu>
 * @author Taiwen Jiang <phppp@users.sourceforge.net>
 * @version $Id: object.php 4121 2010-01-10 14:02:28Z trabis $
 */
        ...
        switch ($this->vars[$key]['data_type']) {
            ...
            case XOBJ_DTYPE_TXTAREA:
                switch (strtolower($format)) {
                    ...
                    case 'e':
                    case 'edit':
                        return $ts->htmlspecialchars($ret, ENT_QUOTES);
                        break 1;
                    case 'p':
                    case 'preview':
                        $html = !empty($this->vars['dohtml']['value']) ? 1 : 0;
                    ...
                    case 'f':
                    case 'formpreview':
                        return $ts->htmlspecialchars($ts->stripSlashesGPC($ret), ENT_QUOTES);
                        break 1;
                    case 'n':
                    case 'none':
                    default:
