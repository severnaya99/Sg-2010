 ...
 * @version         $Id: functions.php 4120 2010-01-10 13:52:49Z trabis $
 */
        ...
        if ($htmlbanner) {
            ...
            if (stristr($imageurl, '.swf')) {
                $bannerobject = $bannerobject
                              ...
                              . '<object type="application/x-shockwave-flash" width="468" height="60" data="' . $imageurl . '" style="position:absolute; z-index:100;">'
