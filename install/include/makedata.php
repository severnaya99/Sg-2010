...
* @version $Id: makedata.php 2717 2009-01-23 09:47:30Z phppp $
*/
...
function make_data(&$dbm, $adminname, $adminpass, $adminmail, $language, $gruops)
{
    ...
    $dbm->insert('config', " VALUES (39, 0, 3, 'footer', '_MD_AM_FOOTER', 'Powered by XOOPS @ 2001-" . date('Y', time()) . " <a href=\"http://xoops.sourceforge.net/\" target=\"_blank\">The XOOPS Project</a>', '_MD_AM_FOOTERDSC', 'textarea', 'text', 20)");
    ...
    $dbm->insert('config', " VALUES (94, 0, 1, 'cpanel', '_MD_AM_CPANEL', 'oxygen', '_MD_AM_CPANELDSC', 'cpanel', 'other', 11)");
