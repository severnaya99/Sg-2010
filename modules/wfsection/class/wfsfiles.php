...
// HTML output
        ...
        function loadPostVars() {
			...
			$this->setFileRealName($HTTP_POST_VARS['filerealname']); 
            $this->setFileShowName($HTTP_POST_VARS['fileshowname']);
       		$this->setArticleid($HTTP_POST_VARS['articleid']);
            $this->setFiletext($HTTP_POST_VARS['filetext']);
            $this->setFiledescript($HTTP_POST_VARS['filedescript']);
			$this->setMinetype($HTTP_POST_VARS['minetype']);
        	$this->setExt($HTTP_POST_VARS['ext']);
        	$this->setDownloadname($HTTP_POST_VARS['downloadname']);
			$this->setGroupid($HTTP_POST_VARS['groupid']);
        }
