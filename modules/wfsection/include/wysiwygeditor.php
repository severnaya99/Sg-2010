...
window.open("<?=XOOPS_URL?>/modules/<?php echo $GLOBALS['drname']?>/images/wysiwyg/help_document.htm","wHelp", "toolbar=10, scrollbars=yes, width=400, height=450");
}
...
<img src="<?=XOOPS_URL?>/modules/<?php echo $GLOBALS['drname']?>/images/wysiwyg/start.gif" align="middle"/>
<img style="cursor:hand;" src="<?=XOOPS_URL?>/modules/<?php echo $GLOBALS['drname']?>/images/wysiwyg/new.gif" align="middle" border="0" alt="New File" onClick="newFile();" />
<img style="cursor:hand;" src="<?=XOOPS_URL?>/modules/<?php echo $GLOBALS['drname']?>/images/wysiwyg/new.gif" align="middle" border="0" alt="Refresh (clear document)" 	onClick="dounredo('Refresh');" />
<img src="<?=XOOPS_URL?>/modules/<?php echo $GLOBALS['drname']?>/images/wysiwyg/separator.gif" align="middle"/>
<img style="cursor:hand;" src="<?=XOOPS_URL?>/modules/<?php echo $GLOBALS['drname']?>/images/wysiwyg/cut.gif"  align="middle" border="0" alt="Cut" 	onClick="doFormat('Cut')" />
<img style="cursor:hand;" src="<?=XOOPS_URL?>/modules/<?php echo $GLOBALS['drname']?>/images/wysiwyg/copy.gif" align="middle" border="0" alt="Copy" 	onClick="doFormat('Copy')" />
<img style="cursor:hand;" src="<?=XOOPS_URL?>/modules/<?php echo $GLOBALS['drname']?>/images/wysiwyg/paste.gif" align="middle" border="0" alt="Paste" 	onClick="doFormat('Paste')"   />
<img src="<?=XOOPS_URL?>/modules/<?php echo $GLOBALS['drname']?>/images/wysiwyg/separator.gif" align="middle"/>
<img style="cursor:hand;" src="<?=XOOPS_URL?>/modules/<?php echo $GLOBALS['drname']?>/images/wysiwyg/undo.gif" align="middle" border="0" alt="Undo" 	onClick="dounredo('Undo')" />
<img style="cursor:hand;" src="<?=XOOPS_URL?>/modules/<?php echo $GLOBALS['drname']?>/images/wysiwyg/redo.gif" align="middle" border="0" alt="Redo" 	onClick="dounredo('Redo')" />
<img src="<?=XOOPS_URL?>/modules/<?php echo $GLOBALS['drname']?>/images/wysiwyg/separator.gif" align="middle"/>
<img style="cursor:hand;" src="<?=XOOPS_URL?>/modules/<?php echo $GLOBALS['drname']?>/images/wysiwyg/picture.gif" align="middle" alt="Insert Picture" onClick="var strURL = window.prompt('Enter URL s Picture','');if (strURL!=null) {doFormat('InsertImage',strURL);}" />
<img style="cursor:hand;" src="<?=XOOPS_URL?>/modules/<?php echo $GLOBALS['drname']?>/images/wysiwyg/hr.gif" align="middle" alt="HR" onClick="doFormat('InsertHorizontalRule')" />
<img style="cursor:hand;" src="<?=XOOPS_URL?>/modules/<?php echo $GLOBALS['drname']?>/images/wysiwyg/link.gif" align="middle" border="0" alt="Link to external site" onClick="doFormat('createlink')" />
...
<img style="cursor:hand;" src="<?=XOOPS_URL?>/modules/<?php echo $GLOBALS['drname']?>/images/wysiwyg/word.gif" align="middle" border="0" alt="Remove MS Word Formatting" onClick="word_<?php echo $textareaname;?>_OnClick()" />

&nbsp;
</td>
<td nowrap="nowrap" class = 'bartop' align="middle";>
<img src="<?=XOOPS_URL?>/modules/<?php echo $GLOBALS['drname']?>/images/wysiwyg/start.gif" align="middle"/>
<img style="cursor:hand;" src="<?=XOOPS_URL?>/modules/<?php echo $GLOBALS['drname']?>/images/wysiwyg/strikethrough.gif" align="middle" alt="Strike through" onClick="doFormat('StrikeThrough')" />
<img style="cursor:hand;" src="<?=XOOPS_URL?>/modules/<?php echo $GLOBALS['drname']?>/images/wysiwyg/subscript.gif" align="middle" alt="SubScript" onClick="doFormat('SubScript')" />
<img style="cursor:hand;" src="<?=XOOPS_URL?>/modules/<?php echo $GLOBALS['drname']?>/images/wysiwyg/superscript.gif" align="middle" alt="SuperScript" onClick="doFormat('SuperScript')" />
<img src="<?=XOOPS_URL?>/modules/<?php echo $GLOBALS['drname']?>/images/wysiwyg/separator.gif" align="middle"/>
<img style="cursor:hand;" src="<?=XOOPS_URL?>/modules/<?php echo $GLOBALS['drname']?>/images/wysiwyg/ed_remove.gif" align="middle" border="0" alt="Remove Format" 	onClick="doFormat('RemoveFormat')"   />
<img style="cursor:hand;" src="<?=XOOPS_URL?>/modules/<?php echo $GLOBALS['drname']?>/images/wysiwyg/selectall.gif" align="middle" border="0" alt="Select All" 	onClick="dounredo('SelectAll')" />
<img style="cursor:hand;" src="<?=XOOPS_URL?>/modules/<?php echo $GLOBALS['drname']?>/images/wysiwyg/selectnone.gif" align="middle" border="0" alt="Select None" 	onClick="dounredo('Unselect')" />
...
<td class = 'bartop'>
<img src="<?=XOOPS_URL?>/modules/<?php echo $GLOBALS['drname']?>/images/wysiwyg/start.gif" align="middle"/>
<img style="cursor:hand;" src="<?=XOOPS_URL?>/modules/<?php echo $GLOBALS['drname']?>/images/wysiwyg/help.gif" align="middle" alt="Help" onClick="Help_OnClick();">
&nbsp;
</td>
</tr>
</table>
...
<td class = 'bartop'>
<img src="<?=XOOPS_URL?>/modules/<?php echo $GLOBALS['drname']?>/images/wysiwyg/start.gif" align="middle"/>
<img style="cursor:hand;" src="<?=XOOPS_URL?>/modules/<?php echo $GLOBALS['drname']?>/images/wysiwyg/bold.gif" align="middle" border="0"  alt="Bold text" onClick="doFormat('Bold')" />
<img style="cursor:hand;" src="<?=XOOPS_URL?>/modules/<?php echo $GLOBALS['drname']?>/images/wysiwyg/italics.gif" align="middle" border="0"  alt="Italic text" onClick="doFormat('Italic')" />
<img style="cursor:hand;" src="<?=XOOPS_URL?>/modules/<?php echo $GLOBALS['drname']?>/images/wysiwyg/underline.gif" align="middle" border="0"  alt="Underline text" onClick="doFormat('Underline')" />
<img src="<?=XOOPS_URL?>/modules/<?php echo $GLOBALS['drname']?>/images/wysiwyg/separator.gif" align="middle"/>
<img style="cursor:hand;" src="<?=XOOPS_URL?>/modules/<?php echo $GLOBALS['drname']?>/images/wysiwyg/aleft.gif" align="middle" alt="Align Left"  onClick="doFormat('JustifyLeft')" />
<img style="cursor:hand;" src="<?=XOOPS_URL?>/modules/<?php echo $GLOBALS['drname']?>/images/wysiwyg/acenter.gif" align="middle" alt="Align Center"  onClick="doFormat('JustifyCenter')" />
<img style="cursor:hand;" src="<?=XOOPS_URL?>/modules/<?php echo $GLOBALS['drname']?>/images/wysiwyg/aright.gif" align="middle" alt="Align Right"  onClick="doFormat('JustifyRight')" />
<img style="cursor:hand;" src="<?=XOOPS_URL?>/modules/<?php echo $GLOBALS['drname']?>/images/wysiwyg/afull.gif" align="middle" alt="Align Full"   onClick="doFormat('JustifyFull')" />
<img style="cursor:hand;" src="<?=XOOPS_URL?>/modules/<?php echo $GLOBALS['drname']?>/images/wysiwyg/anone.gif" align="middle" border="0" alt="Justify None" onClick="doFormat('JustifyNone')"   />
<img src="<?=XOOPS_URL?>/modules/<?php echo $GLOBALS['drname']?>/images/wysiwyg/separator.gif" align="middle"/>
<img style="cursor:hand;" src="<?=XOOPS_URL?>/modules/<?php echo $GLOBALS['drname']?>/images/wysiwyg/para_num.gif" align="middle" border="0" alt="Numbered List" onClick="doFormat('InsertOrderedList');" />
<img style="cursor:hand;" src="<?=XOOPS_URL?>/modules/<?php echo $GLOBALS['drname']?>/images/wysiwyg/para_bul.gif" align="middle" border="0" alt="Bullet List" onClick="doFormat('InsertUnorderedList');" />
<img src="<?=XOOPS_URL?>/modules/<?php echo $GLOBALS['drname']?>/images/wysiwyg/separator.gif" align="middle"/>
<img style="cursor:hand;" src="<?=XOOPS_URL?>/modules/<?php echo $GLOBALS['drname']?>/images/wysiwyg/indent.gif" align="middle" alt="Indent" onClick="doFormat('Indent')" />
<img style="cursor:hand;" src="<?=XOOPS_URL?>/modules/<?php echo $GLOBALS['drname']?>/images/wysiwyg/outdent.gif" align="middle" alt="Outdent" onClick="doFormat('Outdent')" />
<img src="<?=XOOPS_URL?>/modules/<?php echo $GLOBALS['drname']?>/images/wysiwyg/separator.gif" align="middle"/>
</td>
</tr>
</table>
...
<td bgcolor="#FFFFFF">
<iframe name="<?php echo $myEditor;?>" id="<?php echo $myEditor;?>" src="<?=XOOPS_URL?>/modules/<?php echo $GLOBALS['drname']?>/include/pdedit.php?textareaname=<?php echo $textareaname;?>" onfocus="initToolBar(this,'<?php echo $myEditor;?>');" onblur="copyValue_<?php echo $textareaname;?>();" width="100%" height="600"></iframe></td>
</tr>
<td>
<tr height=15>
	<td height=15>
<table width="100%" border="0" cellspacing="0" cellpadding="0" height=15>     
  <tr>     
    ...
    <td align="middle"><IMG src="<?=XOOPS_URL?>/modules/<?php echo $GLOBALS['drname']?>/images/wysiwyg/ScrollL.gif" border=0 width="24" height="15"></td>    
    <td align="middle" width="100%" style="FILTER: Alpha(opacity=50); BACKGROUND-COLOR: white" 
         ></td>    
    <td align="right"><IMG src="<?=XOOPS_URL?>/modules/<?php echo $GLOBALS['drname']?>/images/wysiwyg/ScrollR.gif" border=0 width="19" height="15"></td>    
  </tr>    
  </table>    
</td>
</table>
