...
<table border='0' cellpadding='7' cellspacing='1' width='100%'>
				<tr>
					<td class='bg3'><div align='center'><font size='2'><b>"._MI_STEXMETEO_TITLE."</b></font></div>
					</td>
				</tr>
</table>
<p>
...
<table border='0' cellpadding='0' cellspacing='0' align='center' width='100%'>
	<tr class='bg2'>
		<td class='bg2'>
			...
			<table border='0' cellpadding='4' cellspacing='1' align='center' width='100%'>
				<tr class='bg2'>
					<td class='bg1'><button class='button' type='button' onClick=location.href='".XOOPS_URL."/modules/stexmeteo/ndays.php'>"._MI_STEXMETEO_NEXTDAYS."</button>
					</td>
				</tr>
			</table>
