 ...
 * @subpackage form
 */
class GenobioFormSelectSex extends XoopsFormElement
{
    /**
     * Options
     *
     ...
     */
    function GenobioFormSelectSex($caption, $name, $value = null, $size = 1, $multiple = false)
    {
		...
		$this->addOption('male', 'Male');
		$this->addOption('female', 'Female');
