 ...
 * @version         $Id: formselect.php 3174 2009-04-18 15:00:48Z catzwolf $
 */
 ...
 * @subpackage form
 */
class GenobioFormSelectDisplayPicture extends XoopsFormElement
{
    /**
     * Options
     *
     ...
     */
    function GenobioFormSelectDisplayPicture($caption, $name, $value = null, $size = 1, $multiple = false)
    {
		...
		$this->addOption('baby_photo', 'Baby Photo');
		$this->addOption('midlife_photo', 'Midlife Photo');
		$this->addOption('elderly_photo', 'Elderly Photo');
		$this->addOption('current_photo', 'Current Photo');
