 ...
 * @subpackage form
 */
class GenobioFormSelectSibblings extends XoopsFormElement
{
    /**
     * Options
     *
     ...
     */
    function GenobioFormSelectSibblings($caption, $name, $value = null, $size = 1, $multiple = false)
    {
		...
		$sibblings = $sibblingshandler->getObjects(NULL);
		foreach($sibblings as $slibbling)
			$this->addOption($slibbling->getVar('sibblings_id'), $slibbling->getVar('nickname'));
