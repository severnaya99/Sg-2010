 ...
 * @subpackage form
 */
class GenobioFormSelectCategory extends XoopsFormElement
{
    /**
     * Options
     *
     ...
     */
    function GenobioFormSelectCategory($caption, $name, $value = null, $size = 1, $multiple = false)
    {
		...
		$categories = $categorieshandler->getObjects(NULL);
		foreach($categories as $category)
			$this->addOption($category->getVar('category_id'), $category->getVar('category_name'));
