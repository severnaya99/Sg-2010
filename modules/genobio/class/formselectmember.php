 ...
 * @subpackage form
 */
class GenobioFormSelectMember extends XoopsFormElement
{
    /**
     * Options
     *
     ...
     */
    function GenobioFormSelectMember($caption, $name, $value = null, $size = 1, $multiple = false)
    {
		...
		$members = $membershandler->getObjects(NULL);
		$this->addOption(0, '(none)');
		foreach($members as $member)
			$this->addOption($member->getVar('member_id'), $member->getVar('display_name'));
