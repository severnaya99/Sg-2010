<?php
// $Id: singlelink.php,v 1.13 2004/12/26 19:11:57 onokazu Exp $
//  ------------------------------------------------------------------------ //
...
//And posted here by Elisio Leonardo
$title="";
$cattitle='';
if($cid>0) {
    $sql = "SELECT title FROM ".$xoopsDB->prefix("mylinks_cat")." t where cid=$cid";
    $result=$xoopsDB->query($sql);
	$myrow = $xoopsDB->fetchArray($result);
	$cattitle=$myrow['title'];
}
xoops_create_meta_keywords($description);
xoops_create_meta_description($ltitle.' '.$cattitle);
