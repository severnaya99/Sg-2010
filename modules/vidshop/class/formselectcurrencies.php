 ...
 * @access 		public 
 */
class VidshopFormSelectCurrencies extends XoopsFormElement
{
    /**
     * Options
     *
     ...
     * @access private
     */
    var $_currencies = array(	'GBP' 	=>	'Great British Pound',
     ...
     */
    function VidshopFormSelectCurrencies($caption, $name, $value = null, $size = 1, $multiple = false)
    {
        $this->setCaption($caption);
        $this->setName($name);
        $this->_multiple = $multiple;
        $this->_size = intval($size);
		$this->addOptionArray($this->_currencies);
        if (isset($value)) {
            $this->setValue($value);
        }
    }
