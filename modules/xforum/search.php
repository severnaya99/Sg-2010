...
$xoopsOption['template_main']= 'xforum_search.html';
...
if ( !empty($_POST['submit']) || !empty($_GET['submit']) || !empty($uname) || !empty($term)) {
    ...
    else $results =& forum_search($queries, $andor, $limit, $start, $uid, $xforum, $sortby, $searchin, $subquery);
...
$select_since = forum_sinceSelectBox($xoopsModuleConfig['since_default']);
