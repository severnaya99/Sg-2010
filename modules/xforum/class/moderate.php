...
class xforumModerateHandler extends ArtObjectHandler
{
    function xforumModerateHandler(&$db) {
        $this->ArtObjectHandler($db, 'xf_moderates', 'Moderate', 'mod_id', 'uid');
    }
