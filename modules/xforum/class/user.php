...
class User extends XoopsObject
{
    ...
    function getLevel()
    {
	    global $xoopsModuleConfig, $xforumUrl;
	    $user =& $this->user;
		$level = get_user_level($user);
		if($xoopsModuleConfig['user_level']==2){
			$table = "<table class='userlevel'><tr><td class='end'><img src='" . $xforumUrl['images_set'] . "/rpg/img_left.gif' alt='' /></td><td class='center' background='" . $xforumUrl['images_set'] . "/rpg/img_backing.gif'><img src='" . $xforumUrl['images_set'] . "/rpg/%s.gif' width='%d' alt='' /></td><td><img src='" . $xforumUrl['images_set'] . "/rpg/img_right.gif' alt='' /></td></tr></table>";
