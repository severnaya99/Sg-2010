...
//%%%%%%	File Name  index.php   	%%%%%
define("_AM_XFORUM_FORUMCONF","Configurazione Forum");
define("_AM_XFORUM_ADDAFORUM","Aggiungi nuovo Forum");
define("_AM_XFORUM_SYNCFORUM","Sync forum");
define("_AM_XFORUM_REORDERFORUM","Riordina");
define("_AM_XFORUM_FORUM_MANAGER","Forum");
define("_AM_XFORUM_PRUNE_TITLE","Prune");
define("_AM_XFORUM_CATADMIN","Categorie");
define("_AM_XFORUM_GENERALSET", "Configurazione Modulo" );
define("_AM_XFORUM_MODULEADMIN","Amministrazione Modulo:");
...
define("_AM_XFORUM_TOTALPOSTS","Total Posts");
define("_AM_XFORUM_TOTALTOPICS","Total Topics");
define("_AM_XFORUM_TOTALVIEWS","Total Views");
...
define('_AM_XFORUM_POLLMODULE','Xoops Poll Module');
...
define('_AM_XFORUM_ATTACHPATH','Path for attachment storing');
define('_AM_XFORUM_THUMBPATH','Path for attached image thumbs');
//define('_AM_XFORUM_RSSPATH','Path for RSS feed');
define('_AM_XFORUM_REPORT','Reported posts');
define('_AM_XFORUM_REPORT_PENDING','Pending report');
define('_AM_XFORUM_REPORT_PROCESSED','processed report');
...
define('_AM_XFORUM_DIGEST_ARCHIVE','Digest archive');
