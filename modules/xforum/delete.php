...
if ( $ok ) {
	...
	*/    
	...
	xoops_confirm(array('post_id' => $post_id, 'viewmode' => $viewmode, 'order' => $order, 'forum' => $forum, 'topic_id' => $topic_id, 'ok' => forum_DELETEONE), 'delete.php', _MD_DEL_ONE);
	if($isadmin){
    	xoops_confirm(array('post_id' => $post_id, 'viewmode' => $viewmode, 'order' => $order, 'forum' => $forum, 'topic_id' => $topic_id, 'ok' => forum_DELETEALL), 'delete.php', _MD_DEL_RELATED);
	}
