...
$modversion['status_version'] = "4.05";

$modversion['warning'] = "For XOOPS 2.3, 2.2 & 2.0";
...
if (function_exists('mod_isModuleAction'))
...
$modversion['tables'][10] = "xf_attachments"; // reserved table for next version
$modversion['tables'][11] = "xf_moderates"; // For suspension
...
$modversion['blocks'][1] = array(
	...
	'show_func' => "b_forum_show",
	'options' => "time|5|360|0|1|0",
	'edit_func' => "b_forum_edit",
...
$modversion['blocks'][] = array(
	...
	'show_func' => "b_forum_topic_show",
	'options' => "time|5|360|0|1|0|0",
	'edit_func' => "b_forum_topic_edit",
...
$modversion['blocks'][] = array(
	...
	'show_func' => "b_forum_post_show",
	'options' => "title|10|360|0|1|0|0",
	'edit_func' => "b_forum_post_edit",
...
$modversion['blocks'][] = array(
	...
	'show_func' => "b_forum_author_show",
	'options' => "topic|5|360|0|1|0",
	'edit_func' => "b_forum_author_edit",
...
$modversion["blocks"][]    = array(
    ...
    "show_func"        => "b_forum_tag_block_cloud_show",
    "edit_func"        => "b_forum_tag_block_cloud_edit",
...
$modversion["blocks"][]    = array(
    ...
    "show_func"        => "b_forum_tag_block_top_show",
    "edit_func"        => "b_forum_tag_block_top_edit",
    "options"        => "50|30|c",
...
if( $isModuleAction && "update_ok" == $_POST["op"] ) {
	$forum_handler =& xoops_getmodulehandler('forum', 'xforum', true);
	$xforums = $forum_handler->getForumsByCategory(0, '', false, array("parent_forum", "cat_id", "forum_name"));
	if($xforums):
