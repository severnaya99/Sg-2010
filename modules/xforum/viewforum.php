...
if (isset($_GET['mark_read'])){
	...
	$url = "viewforum.php?start=".$_GET['start']."&amp;forum=".$forum_id."&amp;sortname=".$_GET['sortname']."&amp;sortorder=".$_GET['sortorder']."&amp;since=".$_GET['since'];
...
if ($forum_handler->getPermission($forum_obj, "post")){
	$xoopsTpl->assign('forum_newtopic', "<a href=\"newtopic.php?forum=".$forum_obj->getVar('forum_id')."\">".forum_displayImage($xforumImage['t_new'],_MD_ADDTOPIC)."</a>");
