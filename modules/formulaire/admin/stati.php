...
$qtot = $xoopsDB->fetchRow($sql3);
	...
	if ($qcm == '1') {
		...
		$v .= "<td align='right' width='15%'>Total : ".$qtot[0]."</td></tr></table><hr>";
		$nb++;
		}
	...
	if ($qcm == '1') {
		...
		$v .= "<td align='right' width='15%'>Total : ".$qtot1[0]."</td></tr></table><hr>";
		$nb++;
		}
...
if ($qcm != '1') {
		...
		$v .= "<td align='right' width='15%'>Total : ".$qtot2[0]."</td></tr></table><hr>";
		$nb++;
	}
	...
	if ($qcm == '1') {
		...
		$v .= "<td align='right' width='15%'>Total : ".$qtot3[0]."</td></tr></table><hr>";
		$nb++;
		}
     }
