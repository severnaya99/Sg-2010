...
echo "Script de mise à jour, 3.0x vers 3.2<br />";
echo "Upgrade script, 3.0x to 3.2<br /><br />";

echo "script permettant le passage d'une version 3.0 à la version 3.2. Attention, la restriction sur l'envoi des mails 
ne fonctionnera pas avec les formulaires déjà créés, de plus, ni les titres ni les images des formulaires déjà créés 
ne s'afficheront, veuillez donc modifier les paramètres des formulaires pour rendre ces options accessibles.
Attention, veuillez éviter de modifier un de vos formulaires pour le faire passer en QCM.
