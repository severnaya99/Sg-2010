...
<ul>
	<li>the 2.0.7 xoops version, or more recent</li>
	<li>you have to do a chmod 777 on the module's upload folder</li>
	<li>xoops must be configured to send mails</li>");
...
define("_DOC_MOD_CONFIG","Modulkonfiguration");
define("_DOC_PREF_CONFIG","Einstellungen");
define("_DOC_BLGR_CONFIG","Blöcke und Gruppen");
...
define("_DOC_PARAM_GESFORM","Modify the form's parameters");
...
define("_DOC_STAT_GESFORM","Form status");
...
define("_DOC_PERM_GESFORM","Einstellungen");
...
define("_DOC_UTIL_GESFORM","User side");
...
define("_DOC_MOD_CONSULT","Form consult");
define("_DOC_CONS_CONSULT","Consult");
...
define("_DOC_FORM_CONSULT","Form");
define("_DOC_QCM_CONSULT","QCM");

define("_DOC_STAT_CONSULT","Statistics");
...
define("_DOC_MOD_EXPORT","Form export");
define("_DOC_EXP_EXPORT","Export");
...
define("_DOC_MOD_MENU","Menu management");
...
define("_DOC_MOD_DIV","Others");
define("_DOC_SERV_DIV","Server info");
define("_DOC_ABOUT_DIV","About");
...
define("_DOC_MENU_PREF","Preferences");
define("_DOC_MENU_BLGR","Blocks and Groups");
define("_DOC_MENU_GESFORM","Forms management");
define("_DOC_MENU_CREATFORM","Form creation");
define("_DOC_MENU_RENFORM","Rename a form");
define("_DOC_MENU_SUPFORM","Delete a form");
define("_DOC_MENU_MODFORM","Modify the elements");
define("_DOC_MENU_MODPFORM","Modify the forms' parameters");
define("_DOC_MENU_STAT","Status");
define("_DOC_MENU_PERM","Permissions");
define("_DOC_MENU_USER","User side");
define("_DOC_MENU_CONS","Consult");
define("_DOC_MENU_EXP","Export");
define("_DOC_MENU_MEN","Menu");
define("_DOC_MENU_DIV","Others");
define("_DOC_MENU_REC","Recommendations");
define("_DOC_MENU_STATI","Statistics");
?>