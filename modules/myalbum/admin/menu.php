<?php
$adminmenu[0]['title'] = _ALBM_MYALBUM_ADMENU2;
$adminmenu[0]['link'] = "admin/index.php";
$adminmenu[1]['title'] = _ALBM_MYALBUM_ADMENU1;
$adminmenu[1]['link'] = "admin/photomanager.php";
$adminmenu[2]['title'] = _ALBM_MYALBUM_ADMENU0;
$adminmenu[2]['link'] = "admin/admission.php";
$adminmenu[3]['title'] = _ALBM_MYALBUM_ADMENU3;
$adminmenu[3]['link'] = "admin/checkconfigs.php";
