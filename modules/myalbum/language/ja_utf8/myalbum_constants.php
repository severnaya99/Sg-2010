...
define( "_ALBM_GPERM_G_TELLAFRIEND" , "友人に知らせる" ) ;

// Caption
define( "_ALBM_CAPTION_TOTAL" , "Total:" ) ;
define( "_ALBM_CAPTION_GUESTNAME" , "ゲスト" ) ;
define( "_ALBM_CAPTION_REFRESH" , "更新" ) ;
define( "_ALBM_CAPTION_IMAGEXYT" , "サイズ" ) ;
define( "_ALBM_CAPTION_CATEGORY" , "カテゴリー" ) ;
