...
define("_ALBM_DELETINGPHOTO","削除しました");
define("_ALBM_MOVINGPHOTO","移動しました");

define("_ALBM_STORETIMESTAMP","日時を変更しない");
...
define("_ALBM_SUBJECT4TAF","面白い写真を見つけました");
