...
define("_ALBM_BTITLE_RANDOM","Random Photo");
...
define("_ALBM_TEXT_CATLIMITRECURSIVE","with Sub-categories");
define("_ALBM_TEXT_BLOCK_WIDTH","Displays max");
define("_ALBM_TEXT_BLOCK_WIDTH_NOTES","(if you set this to 0, the thumbnail image displays in its original size.)");
