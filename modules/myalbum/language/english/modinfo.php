...
define("_ALBM_BNAME_RANDOM","Random Photo");
define("_ALBM_BNAME_RECENT_P","Recent Photos with thumbnails");
define("_ALBM_BNAME_HITS_P","Top Photos with thumbnails");
...
define( "_ALBM_CFG_DESCIMAGINGPIPE" , "Almost all PHP environments can use GD. But GD is functionally inferior than 2 other packages.<br />It is best to use ImageMagick or NetPBM if you can." ) ;
...
define( "_ALBM_CFG_ALLOWNOIMAGE" , "Allow a submit without images" ) ;
define( "_ALBM_CFG_MAKETHUMB" , "Make Thumbnail Image" ) ;
...
define( "_ALBM_CFG_DESCFSIZE" , "The limitation of the size of uploading file.(bytes)" ) ;
...
define( "_ALBM_CFG_DESCALLOWEDEXTS" , "Input extensions with separator '|'. (eg 'jpg|jpeg|gif|png') .<br />All characters must be lowercase. Don't insert periods or spaces<br />Never add php or phtml etc." ) ;
...
define( "_ALBM_OPT_USENAME" , "Real Name" ) ;
...
define("_ALBM_MYALBUM_ADMENU3","Check Configuration & Environment");
...
define('_MI_MYALBUM_GLOBAL_NEWPHOTO_NOTIFYCAP', 'Notify me when any new photos are posted');
define('_MI_MYALBUM_GLOBAL_NEWPHOTO_NOTIFYDSC', 'Receive notification when a new photo description is posted.');
