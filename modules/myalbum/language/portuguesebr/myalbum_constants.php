...
define('_ALBM_GPERM_G_TELLAFRIEND','Recomende para um amigo');
...
define( "_ALBM_GPERM_G_INSERTABLE" , "Envio (requer aprovação)" ) ;
define( "_ALBM_GPERM_G_SUPERINSERT" , "Super Envio" ) ;
define( "_ALBM_GPERM_G_EDITABLE" , "Editar (requer aprovação)" ) ;
define( "_ALBM_GPERM_G_SUPEREDIT" , "Super Edição" ) ;
define( "_ALBM_GPERM_G_DELETABLE" , "Deletar (requer aprovação)" ) ;
define( "_ALBM_GPERM_G_SUPERDELETE" , "Super Deleção" ) ;
