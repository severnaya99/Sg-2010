<?php
// $Id: wfscategory.php,v 1.3 2005/06/25 10:24:11 ohwada Exp $

// 2004/02/26 K.OHWADA
// bug fix: constant parse error
//   orders -> "orders"

// 2003/10/11 K.OHWADA
// easy to rename module and table
//   change function WfsCategory, countByArticle
...
//global $wfsModule;
//include_once(XOOPS_ROOT_PATH."/modules/$wfsModule/include/functions.php");
//include_once(XOOPS_ROOT_PATH."/modules/$wfsModule/class/wfstree.php");
...
// constructor
	...
	function WfsCategory($catid=0){
		...
		global $wfsTableCategory;
	
		$this->db =& Database::getInstance();

// easy to rename module and table
//		$this->table = $this->db->prefix("wfs_category");
		$this->table = $this->db->prefix($wfsTableCategory);
...
// public - WfsCategory::* style
        ...
        function countByArticle($articleid=0){
                ...
                global $wfsTableCategory;	// add
                
                $db =& Database::getInstance();

// easy to rename module and table
//		$sql = "SELECT COUNT(*) FROM ".$db->prefix("wfs_category")."";
		$sql = "SELECT COUNT(*) FROM ".$db->prefix($wfsTableCategory)."";
