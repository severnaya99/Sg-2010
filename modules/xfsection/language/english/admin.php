...
// admin menu same as popup menu
define("_AM_PREFERENCE",'Preferences');
define("_AM_PATH_MANAGEMENT","Path Management");
define("_AM_LIST_BROKEN",'List Broken downloads');
...
// unify a article menu and a title
define("_AM_ALLTXT","With <b>Article Management</b> you can edit, delete or rename any article. This mode will show every article within the database.<br /><br />"); //added
define("_AM_PUBLISHEDTXT","<b>Article Published Management</b> will show all articles that have been published (Approved by Webmaster).<br /><br />These are all the articles that will be shown in category listing of the XF-Section index page (including all those controlled by groupaccess).<br /><br />"); //added
define("_AM_SUBMITTEDTXT","<b>Article Submission management</b> will show all articles submitted by your website users and allow you to moderate them.<br /><br />To approve an article, click on <b>Edit</b> link, then highlight the <b>Approve</b> checkbox and the save the article. The submitted article will then be published.<br /><br />"); //added
define("_AM_ONLINETXT","<b>Article Online Management</b> will show all articles which status has been set to 'online'.<br /><br />To change the status of an article, click on the <b>Edit</b> link and highlight the <b>online</b> checkbox off/on.<br /><br />"); //added
define("_AM_OFFLINETXT","<b>Article Offline Management</b> will show all articles which status has been set to <b>offline</b>.<br /><br />To change the status of an article, click on the <b>Edit</b> link and highlight the <b>online</b> checkbox off/on.<br /><br />"); //added
define("_AM_EXPIREDTXT","<b>Article Expired Management</b> will show all articles that have expired.<br /><br />You can easily reset the expire date by clicking on <b>Edit</b> link and by changing the <b>Set the date/time of expiration</b> setting.<br /><br />"); //added
define("_AM_AUTOEXPIRETXT","<div><b>Article Auto Expired Management</b> will show all articles that have been set to expire on a certain date.<br /><br />You can reset the expire date by clicking on <b>Edit</b> link and changing the <b>Set the date/time of expiration</b> setting.<br /><br />"); //added
define("_AM_AUTOTXT","<b>Article Auto Publish Management</b> will show all articles that have been set to publish at a future date.<br /><br />This setting can be changed by clicking on the <b>edit</b> link and changing the 'Set the date/time of publish' setting.<br /><br />"); //added
define("_AM_NOSHOWTXT","<b>No Show Article</b> The are a special type of article, unlike your normal articles these will not show up in article index pages and will not be seen that way.&nbsp;&nbsp; Instead, these article will only show in the `XF-Section Menu block`.<br /><br />Using this option with HTML Pages and `No Display info` (Option on the edit article page) you can show just what you want. &nbsp;&nbsp;An example of this would be a `privacy notice` page etc.<br /><br />All other options control these types of articles also. i.e. published, expired, online/offline.<br /><br />"); //added
...
// WF -> XF
define("_AM_CMODERRORINFO","Checks directories and files for proper writable permissions.<br/><br/>XF-Section will try to CHMOD the directories used. An error message will be shown if the write permissions are not correct.");
...
// WF -> XF
define("_AM_WEBMASTONLY","Only Webmaster can change XF-Section Configuration?");
...
// WF -> XF
define("_AM_REVERTED","XF-Section config restored to their defaults");
...
define("_AM_TURNOFFLINE","Hide XF-Section? (Only admin can access XF-Section)");
...
// WF -> XF
define("_AM_DLCONF","XF-Section Downloads Configuration");
...
// WF -> XF
define("_AM_NOADMINRIGHTS","Sorry, only the Webmaster can change XF-Section's configuration");
...
// add
define('_AM_DUPLICATE_ARTICLES','Also copy articles');
...
// index.php
define("_AM_DIR_NOT_WRITABLE","directory is not writable");
define("_AM_EDIT_ARTICLE_RETURN","Return to Edit Article");

// copy mode in index.php
define("_AM_COPY_ARTICLE_EXPLANE","Copy Article. The original article is left. Atached files are not copied.");
...
define("_AM_IMPORT_DIRNAME", "Directory name or File name");
