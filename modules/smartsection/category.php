...
if ( empty( $xoopsOption['template_main'] ) ) {
	$xoopsOption['template_main'] = 'smartsection_display' . '_' . $xoopsModuleConfig['displaytype'] . '.html';
}
 ...
 */
$smartsection_metagen = new SmartsectionMetagen($categoryObj->getVar('name'), $categoryObj->getVar('meta_keywords','n'), $categoryObj->getVar('meta_description', 'n'), $categoryObj->getCategoryPathForMetaTitle());
