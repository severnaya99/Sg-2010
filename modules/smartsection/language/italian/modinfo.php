...
// Config options
define('_MI_SSECTION_ALLOWADMINHITS', 'Contatore delle letture per Admin:');
define('_MI_SSECTION_ALLOWADMINHITSDSC', 'Consenti di contare le letture effettuate come admin?');
define('_MI_SSECTION_ALLOWCOMMENTS', "Controlla i commenti a livello di articolo:");
define('_MI_SSECTION_ALLOWCOMMENTSDSC', "Se scegli 'Si', vedrai i commenti solo sugli elementi che hanno la casella di selezione dei commenti. <br /><br />Seleziona 'No' per gestire i commenti a livello globale (guarda nella sezione 'Preferenze modulo').");
...
define("_MI_SSECTION_ALLOWUPLOAD", "Upload di file da parte degli Utenti");
define("_MI_SSECTION_ALLOWUPLOADDSC", "Consenti agli utenti registrati di allegare files agli articoli?");
...
define('_MI_SSECTION_AUTOAP_SUBITEM', "Gli articoli sono automaticamente approvati:");
define('_MI_SSECTION_AUTOAP_SUBITEMDSC', "Gli articoli sono automaticamente approvati senza l'intervento dell'amministratore.");
define('_MI_SSECTION_BOTH_FOOTERS','Entrambi');
define('_MI_SSECTION_CAT_CON_OPT', 'Impostazione Generali');
define('_MI_SSECTION_CAT_CON_OPT_DSC', '');
define('_MI_SSECTION_CAT_PRI_OPT', 'Impostazione di Stampa');
define('_MI_SSECTION_CAT_PRI_OPT_DSC', '');
define('_MI_SSECTION_CAT_FOR_OPT', 'Impostazioni di Impaginazione');
define('_MI_SSECTION_CAT_FOR_OPT_DSC', '');
define('_MI_SSECTION_CAT_PERM', 'Permessi opzionali');
define('_MI_SSECTION_CAT_PERM_DSC', '');
define('_MI_SSECTION_CATPERPAGE', 'Numero di Categorie per pagina (Lato utente):');
define('_MI_SSECTION_CATPERPAGEDSC', 'Numero massimo di categorie principali da mostrare dal lato utente in una pagina alla volta.');
define('_MI_SSECTION_COLLAP_HEADING', "Mostra barra a scomparsa");
define('_MI_SSECTION_COLLAP_HEADING_DSC', "Se scegli 'Si', La 'Vista Sommario' delle Categorie sarà mostrata in una barra a scomparsa, così come gli articoli. Se scegli 'No', la barra a scomparsa non sarà mostrata.");
define('_MI_SSECTION_DATEFORMAT', 'Formato data:');
define('_MI_SSECTION_DATEFORMATDSC', 'Usa le impostazioni riportate alla fine di language/.../global.php per selezionare una modalità di visualizzazione. Esempio: "d-M-Y H:i" verrà tradotto in "30-Mar-2004 22:35"');
define('_MI_SSECTION_DISPLAY_CAT_SUMMARY', "Mostra il sommario della categoria?");
define('_MI_SSECTION_DISPLAY_CAT_SUMMARY_DSC', "Selezionando 'Si' il sommario della categoria sarà mostrato nel modulo.");
...
define("_MI_SSECTION_DISPLAY_COMMENT", "Mostra il contatore dei commenti?");
define("_MI_SSECTION_DISPLAY_COMMENT_DSC", "Selezionando 'Si' sarà mostrato il contatore dei commenti in ogni articolo.");
define('_MI_SSECTION_DISPLAY_DATE_COL', "Mostra la colonna 'Data'?");
define('_MI_SSECTION_DISPLAY_DATE_COLDSC', "Quando la modalità 'Vista Sommario' è selezionata, selezionando 'Si' sarà mostrata la data nella tabella dell'elemento nella pagina della categoria e nella pagina principale.");
define('_MI_SSECTION_DISPLAY_HITS_COL', "Mostra la colonna 'Letture'?");
define('_MI_SSECTION_DISPLAY_HITS_COLDSC', "Quando la modalità 'Vista Sommario' è selezionata, selezionando 'Si' sarà mostrata la colonna 'Letture' nella tabella degli elementi nella pagina principale e in quella delle categorie.");
define('_MI_SSECTION_DISPLAY_LAST_ITEM', 'Mostra la colonna Ultimo elemento?');
define('_MI_SSECTION_DISPLAY_LAST_ITEMDSC', "Seleziona 'Si' per mostrare l'ultimo elemento di ciacuna categoria nella pagina principale e in quella delle categorie.");
define('_MI_SSECTION_DISPLAY_LAST_ITEMS', 'Mostra la lista degli articoli recentemente pubblicati:');
define('_MI_SSECTION_DISPLAY_LAST_ITEMS_DSC', "Seleziona 'Si' per avere la lista in fondo alla pagina principale del modulo");
define('_MI_SSECTION_DISPLAY_SBCAT_DSC', 'Mostra la descrizione delle sub categorie ?');
define('_MI_SSECTION_DISPLAY_SBCAT_DSCDSC', "Seleziona 'Si' per mostrare la descrizione delle sub categorie nella nella pagina principale e nella pagina delle categorie.");
define("_MI_SSECTION_DISPLAY_WHOWHEN", "Mostra l'autore e la data?");
define("_MI_SSECTION_DISPLAY_WHOWHEN_DSC", "Seleziona 'Si' per mostrare l'autore e la data in ogni articolo.");
define('_MI_SSECTION_DISPLAYTYPE', "Modalità di visualizzazione degli articoli:");
...
define('_MI_SSECTION_DISPLAYTYPEDSC', "Se è selezionata la modalità 'Vista Sommario', sarà mostrato solo il Titolo, Data e le Letture di ciascun articolo della categoria selezionata. Se è selezionata 'Vista Completa', sarà mostrato il testo completo degli articoli della categoria selezionata.");
...
define('_MI_SSECTION_HIGHLIGHT_COLOR', "Colore per evidenziare le parole chiave");
define('_MI_SSECTION_HIGHLIGHT_COLORDSC', "Colore da usare per evidenziare le parole chiave usate nella funzione di ricerca");
...
define('_MI_SSECTION_INDEXWELCOMEMSG', "Messaggio di benvenuto della pagina principale:");
define('_MI_SSECTION_INDEXWELCOMEMSGDEF', ""); 
define('_MI_SSECTION_INDEXWELCOMEMSGDSC', "Messaggio iniziale da mostrare nella pagina principale del modulo.");
...
define('_MI_SSECTION_LAST_ITEM_SIZE', 'Lunghezza titolo Ultimo elemento:');
define('_MI_SSECTION_LAST_ITEM_SIZEDSC', "Imposta la lunghezza massima del titolo nella colonna Ultimo elemento.");
define('_MI_SSECTION_LINKED_PATH', 'Abilita links ipertestuali sul percorso:');
define('_MI_SSECTION_LINKED_PATHDSC', "Questa opzione consente agli utenti di navigare cliccando su una parte del percorso corrente mostrato in cima alla pagina");
define('_MI_SSECTION_ORDERBYDATE', 'Ordina in base a:');
define('_MI_SSECTION_ORDERBYDATEDSC', 'Seleziona la modalità di ordinamento degli elementi. La modalità influisce sulla presentazione dal lato utente');
...
define('_MI_SSECTION_OTHER_ITEMS_TYPE', 'Modalità di visualizzazione per gli altri articoli');
define('_MI_SSECTION_OTHER_ITEMS_TYPE_ALL', "Tutti gli articoli");
define('_MI_SSECTION_OTHER_ITEMS_TYPE_DSC', 'Seleziona come mostrare gli altri articoli della categoria nella pagina dell\'articolo');
...
define('_MI_SSECTION_PAGE_CATEGORY','Pagine Categoria');
define('_MI_SSECTION_PAGE_ITEM','Pagine Articolo');
...
define('_MI_SSECTION_SHOW_MOD_BCRUMB', 'Mostra il nome del modulo nella riga di orientamento');
define('_MI_SSECTION_SHOW_MOD_BCRUMBDSC', 'Se selezioni "Si", la riga di orientamento sarà "Smartsection > nome della categoria > titolo Articolo". <br>Altrimenti, sarà mostrato solo "nome della categoria > titolo Articolo"');
define('_MI_SSECTION_SHOW_SUBCATS', "Mostra le sub categorie nella pagina principale");
define('_MI_SSECTION_SHOW_SUBCATS_DSC', "Seleziona 'Si' per mostrare le sub categorie nella pagina principale del modulo");
define('_MI_SSECTION_SUBMITINTROMSG', "Messaggio per la pagina di invio:");
define('_MI_SSECTION_SUBMITINTROMSGDEF', "");
define('_MI_SSECTION_SUBMITINTROMSGDSC', "Messaggio introduttivo da mostrare nella pagina principale del modulo quando un utente vuole inviare un articolo");
define('_MI_SSECTION_TITLE_AND_WELCOME', "Mostra il titolo di benvenuto e il messaggio:");
define('_MI_SSECTION_TITLE_AND_WELCOME_DSC', "Scegliendo 'Si', nella pagina principale del modulo sarà mostrata la frase 'Welcome in the SmartSection of...', seguita dal messaggio di benvenuto definito sopra. Se scegli 'No', non sarà mostrato nessun messaggio.");
...
define('_MI_SSECTION_USE_WYSIWYG', "Text editor");
define('_MI_SSECTION_USE_WYSIWYG_DSC', "Seleziona il tipo di editor da usare in questo modulo.");
define('_MI_SSECTION_USEIMAGENAVPAGE', 'Usa le immagini per navigare tra le pagine:');
define('_MI_SSECTION_USEIMAGENAVPAGEDSC', 'Se scegli "Si", la Pagina di navigazione sarà mostrata con le icone, altrimenti sarà usata la Pagina di navigazione originale.');
...
// Beta
define('_MI_SSECTION_WARNING_BETA', "This module comes as is, without any guarantees whatsoever. 
...
// RC
define('_MI_SSECTION_WARNING_RC', "This module comes as is, without any guarantees whatsoever. This module 
...
// Final
define('_MI_SSECTION_WARNING_FINAL', "This module comes as is, without any guarantees whatsoever. Although this 
