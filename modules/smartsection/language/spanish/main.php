...
define("_MD_SSECTION_ACTION", "Acción");
define("_MD_SSECTION_ADD_FILE", "Añadir un archivo");
define("_MD_SSECTION_ADD_FILE_INTRO", "Por favor, cumplimente el formulario si desea añadir un archivo adjunto a este artículo: '%s'.");
define("_MD_SSECTION_ADD_FILE_TITLE", "Añadir un archivo a un artículo");
define("_MD_SSECTION_ADMIN_PAGE", ":: Sección Administrativa ::");
define("_MD_SSECTION_ALL", "Todos");
define("_MD_SSECTION_ALLOWCOMMENTS", "¿Permitir comentarios?");
define("_MD_SSECTION_APPROVE", "Aprobar");
define("_MD_SSECTION_BODY", "Texto extendido");
define("_MD_SSECTION_BODY_DSC", "Texto extendido del artículo");
define("_MD_SSECTION_BODY_REQ", "Texto extendido*");
define("_MD_SSECTION_CANCEL", "Cancelar");
define("_MD_SSECTION_CATEGORY", "Categoría");
define("_MD_SSECTION_CATEGORY_DSC", "Categoría del artículo.");
define("_MD_SSECTION_CATEGORY_EDIT", "Editar categoría");
...
define("_MD_SSECTION_CREATE", "Crear artículo");
define("_MD_SSECTION_DATE", "Fecha");
define("_MD_SSECTION_DATESUB", "Publicado el");
define("_MD_SSECTION_DELETE", "Borrar artículo");
...
define("_MD_SSECTION_EDIT", "Editar artículo");
define("_MD_SSECTION_EDIT_ARTICLE", "Editar un artículo");
define("_MD_SSECTION_EMPTY", "Esta categoría no contiene artículos o subcategorías");
define("_MD_SSECTION_ERROR_ITEM_NOT_SAVED", "Ocurrió un error. El artículo no fue grabado en la base de datos.");
define("_MD_SSECTION_FILE", "Archivos");
define("_MD_SSECTION_FILE_ADD", "Añadiendo un archivo");
...
define("_MD_SSECTION_FILE_EDITING_SUCCESS", "El archivo fue modificado satisfactoriamente.");
...
define("_MD_SSECTION_HITSDETAIL", "" . "Este artículo ha sido leído");
...
define("_MD_SSECTION_ITEMS_INFO", "Aquí tiene los artículo pertenecientes a esta categoría.");
...
define("_MD_SSECTION_MAINNOITEMS", "No hay artículos en esta categoría");
define("_MD_SSECTION_MAINNOSELECTCAT", "No eligió una categoría válida");
define("_MD_SSECTION_NAME", "Nombre");
define("_MD_SSECTION_NEED_CATEGORY_ITEM", "Para crear un artículo deberá configurar apropiadamente los permisos para al menos una de las categorías existentes.");
define("_MD_SSECTION_NEXT_ITEM", "Artículo siguiente");
define("_MD_SSECTION_NO", "No");
define("_MD_SSECTION_NO_CAT_EXISTS", "Lo lamentamos: no se definió aún ninguna categoría.<br />Por favor, contacte con el administardor del sitio y comuníquele la incidencia.");
define("_MD_SSECTION_NO_CAT_PERMISSIONS", "Lo lamentamos: no está autorizado para acceder a esta area.");
define("_MD_SSECTION_NO_TOP_PERMISSIONS", "Lo lamentamos: no hay artículos para mostrar.");
define("_MD_SSECTION_NOCATEGORYSELECTED", "No eligió una categoría válida");
define("_MD_SSECTION_NOITEMS_INFO", "Actualmente no hay artículos para mostrar.");
define("_MD_SSECTION_NOITEMSELECTED", "No eligió un artículo válido");
define("_MD_SSECTION_NONE", "Nada");
define("_MD_SSECTION_NOTIFY", "¿Notificar su publicación?");
define("_MD_SSECTION_OF", "de");
define("_MD_SSECTION_ON", "el");
define("_MD_SSECTION_OPTIONS", "Opciones");
define("_MD_SSECTION_OTHER_ITEMS", "Otros artículos en esta categoría");
define("_MD_SSECTION_PAGE", "Página");
define("_MD_SSECTION_PDF", "Mostrar este artículo en formato PDF");
...
define("_MD_SSECTION_SENDSTORY", "Referir este artículo a un amigo");
define("_MD_SSECTION_SMARTITEMS_INFO", "Aquí tiene los artículos que pertenecen a esta categoría.");
define("_MD_SSECTION_SUB_CLONE", "Duplicar un artículo");
define("_MD_SSECTION_SUB_INTRO", "Por favor, cumplimente este formulario para enviar un artículo. El administrador lo revisará y publicará tan pronto como le sea posible. Gracias sinceras por su contribución.");
define("_MD_SSECTION_SUB_SMNAME", "Enviar un artículo");
define("_MD_SSECTION_SUB_SNEWNAME", "Enviar un artículo");	
define("_MD_SSECTION_SUBCATEGORIES_INFO", "Subcategorías de <em>%s</em> :");
define("_MD_SSECTION_SUBMIT", "Enviar un artículo");
define("_MD_SSECTION_SUBMIT_ERROR", "Ocurrió un error. Su artículo no fue enviado.");
define("_MD_SSECTION_SUBMITITEM", "Enviar un artículo");
define("_MD_SSECTION_SUMMARY", "Introducción");
define("_MD_SSECTION_SUMMARY_DSC", "Introducción del artículo");
define("_MD_SSECTION_THE", "el");
define("_MD_SSECTION_TIMES", "veces");
define("_MD_SSECTION_TITLE", "Títulos");
