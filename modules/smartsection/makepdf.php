...
$pdf_data['subtitle'] = _MD_SSECTION_CATEGORY . ' : ' . $categoryObj->name();
$pdf_data['subsubtitle'] = '';
$pdf_data['date'] = sprintf(_MD_SSECTION_WHO_WHEN, $itemObj->posterName(), $itemObj->datesub());
...
$pdf_config['logo']['path'] = smartsection_getConfig('printlogourl');
