...
define('_NOCOMMENTS_BEGIN4b', 'Note! Only the first module with the comments hack, needs the preloads folder, so if you for example have this module installed, drop the included preloads folder for the rest of the modules you want to add the hack to!');
