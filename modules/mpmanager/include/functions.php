...
//compte les messages categorie
 ...
 $subcategories .= "<td><div style='display: $display; margin-left: 50px; padding: 5px; text-align:left;' class='".$count."'><input type='radio' id='ct_file' name='ct_file' value='".$pm_cat2[$i]->getVar('cid')."'  onClick='ChangeStatut2(this)' ".$checked."/>&nbsp;<img src='".XOOPS_URL."/modules/".$xoopsModule->dirname()."/images/file.png' alt='"._MP_RE."' />&nbsp;&nbsp;<span style='vertical-align:top;'><a href='msgbox.php?catbox=".$pm_cat2[$i]->getVar('cid')."'>".$pm_cat2[$i]->getVar('title')."</a></span></div></td><td valign='middle' align='center' ><div style='display: $display;' class='".$count."'>".$newscta."</div></td><td valign='middle' align='center'><div style='display: $display;' class='".$count."'>".$oldcta."</div></td><td valign='middle' align='center'><div style='display: $display; padding: 5px;' class='".$count."'>
...
foreach ($_menu as $option => $name) {
      ...
      $form .= "<a href='" . $option . "' $opt_selected><span class='head'>" . $name . "</span></a>";
    } 
    $form .= "</div>";
...
$xoTheme->addScript(XOOPS_URL."/modules/mpmanager/include/multifile.js");
$xoTheme->addScript(XOOPS_URL."/modules/mpmanager/include/jquery.js");
$xoTheme->addScript(XOOPS_URL."/modules/mpmanager/layer.js");
$xoTheme->addStylesheet(XOOPS_URL."/modules/mpmanager/mpstyle.css");
}else {
$mp_module_header = "<link rel='stylesheet' type='text/css' href='" . XOOPS_URL . "/modules/mpmanager/mpstyle.css'/><script type='text/javascript' src='".XOOPS_URL."/modules/mpmanager/include/multifile.js'></script><script type='text/javascript' src='".XOOPS_URL."/modules/mpmanager/include/jquery.js'></script><script type='text/javascript' src='".XOOPS_URL."/modules/mpmanager/layer.js'></script>";
...
function mp_select ($catbox, $after, $limit_msg, $sortname, $sortorder)
{
 ...
 $liste_date = new XoopsFormTextDateSelect('', 'after', '15', $after); 
...
global $xoopsModule, $xoopsConfig;
	...
	echo "<ul>";
	echo "<li id='" . $tblColors[0] . "'><a href=\"index.php\"><span>"._MP_ADMENU0."</span></a></li>";
	echo "<li id='" . $tblColors[1] . "'><a href=\"tris.php\"><span>" . _MP_ADMENU1 . "</span></a></li>";
	echo "<li id='" . $tblColors[4] . "'><a href=\"notification.php\"><span>" . _MP_ADMENU4 . "</span></a></li>";
	echo "<li id='" . $tblColors[5] . "'><a href=\"index.php?op=stats\"><span>" . _MP_ADMENU5 . "</span></a></li>";
    echo "<li id='" . $tblColors[6] . "'><a href=\"file.php\"><span>" . _MP_ADMENU6 . "</span></a></li>";
	echo "<li id='" . $tblColors[7] . "'><a href=\"anim.php\"><span>" . _MP_ADMENU7 . "</span></a></li>";
	echo "<li id='" . $tblColors[8] . "'><a href=\"groupperm_global.php\"><span>" . _MP_ADMENU8 . "</span></a></li>";
