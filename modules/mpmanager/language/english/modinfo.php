...
define("_BL_MP_STATS","My Contacts");
...
//2.7
define("_MP_AUTOHTML", "Allow HTML");
define('_MP_AUTOHTML_DESC','Allow html in messages.');
define("_MP_AUTO_MESS", "Uid your last.");
define("_MP_MAXTITLE", "Number of characters taken into account for the suject of a message.");
?>