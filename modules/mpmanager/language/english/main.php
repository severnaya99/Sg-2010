...
//fichier joint
define("_MP_MIMETYPE2","The authorized files:");
...
//define("_MP_MDELALL","Empty");
define("_MP_NHTML", "Not Allow HTML");
define('_MP_OHTML','Allow HTML');
define('_MP_NONESUBJ','No Subject');
?>