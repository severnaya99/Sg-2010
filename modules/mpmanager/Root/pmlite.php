...
include_once XOOPS_ROOT_PATH.'/modules/mpmanager/class/mpthemeform.php';
...
echo '<script type="text/JavaScript"><!--
  ...
  var w=800;
   window.resizeTo(w, h);
 // -->
 </script><script type="text/javascript" src="'.XOOPS_URL.'/modules/mpmanager/include/multifile.js"></script><link rel="stylesheet" type="text/css" href="' . XOOPS_URL . '/modules/mpmanager/mpstyle.css"/>';
...
$send = !empty($_REQUEST['send']) ? 1 : 0;
$send2 = !empty($_REQUEST['send2']) ? 1 : 0;
$to_userid = !empty($_REQUEST['to_userid']) ? intval($_REQUEST['to_userid']) : 0;
$msg_id = !empty($_REQUEST['msg_id']) ? intval($_REQUEST['msg_id']) : 0;
