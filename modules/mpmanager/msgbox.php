...
if ($catbox == 2) {
$box_actions[] = "<input type='submit' class='xo-message-form' onclick='document.prvmsg.action=\"msgbox.php?op=sendbox&reply=1\"' id='stop' disabled value='"._MP_MREPLY."'>";
}else {
$box_actions[] = "<input type='submit' class='xo-message-form' onclick='document.prvmsg.action=\"msgbox.php?op=sendbox&reply=1\"' id='reply' disabled value='"._MP_MREPLY."'>";
} }else {
$box_actions[] = '<select name="add" OnChange="window.document.location=this.options[this.selectedIndex].value;" disabled class="xo-message-form"><option selected>'._MP_MNEWS.'</option><option value="'.XOOPS_URL.'/modules/'.$mydirname.'/msgbox.php?op=sendbox&send=1">-> '._MP_MMES.'</option><option value="'.XOOPS_URL.'/modules/'.$mydirname.'/contbox.php?op=sendbox">-> '._MP_MCONT.'</option><option value="'.XOOPS_URL.'/modules/'.$mydirname.'/filebox.php?op=sendbox">-> '._MP_MFILE.'</option></select>';
$box_actions[] = "<input type='submit' onclick='document.prvmsg.action=\"msgbox.php?op=sendbox&reply=1\"' id='stop' disabled value='"._MP_MREPLY."' class='xo-message-form'>";
}
}
$box_actions[] = "<input type='submit' onclick='document.prvmsg.action=\"delbox.php?option=delete_messages\"' id='del' disabled value='"._MP_MDEL."' class='xo-message-form'>";
$box_actions[] = "<input type='submit' onclick='document.prvmsg.action=\"delbox.php?option=read_messages&read=1\"' id='lu' disabled value='"._MP_MLU."' class='xo-message-form'>";
$box_actions[] = "<input type='submit' onclick='document.prvmsg.action=\"delbox.php?option=read_messages&read=0\"' id='nlu' disabled value='"._MP_MNLU."' class='xo-message-form'>";
$box_actions[] = "<input type='submit' onclick='document.prvmsg.action=\"delbox.php?option=move_messages\"' id='move' disabled value='"._MP_MMOVE."' class='xo-message-form'>";
...
$box_actions[] = '<select name="add" class="xo-message-form" OnChange="window.document.location=this.options[this.selectedIndex].value;"><option selected>'._MP_MNEWS.'</option><option value="'.XOOPS_URL.'/modules/'.$mydirname.'/msgbox.php?op=sendbox&send=1">-> '._MP_MMES.'</option><option value="'.XOOPS_URL.'/modules/'.$mydirname.'/contbox.php?op=sendbox">-> '._MP_MCONT.'</option><option value="'.XOOPS_URL.'/modules/'.$mydirname.'/filebox.php?op=sendbox">-> '._MP_MFILE.'</option></select>';
if ($catbox == 2) {
$box_actions[] = "<input type='submit' class='xo-message-form' name='post_messages' onsubmit='xoopsFormValidate_read();' id='post_messages' disabled value='"._MP_SUBMIT."'>";
}else {
$box_actions[] = "<input type='submit' class='xo-message-form' name='post_messages' onsubmit='xoopsFormValidate_read();' id='post_messages' value='"._MP_SUBMIT."'>";
} }else {
...
if ($reply == 1) {
$box_actions[] = "<input type='button' class='xo-message-form' name='quote' onclick='xoopsGetElementById(\"message\").value=xoopsGetElementById(\"message\").value+ xoopsGetElementById(\"hidden_quote\").value;xoopsGetElementById(\"hidden_quote\").value=\"\";'' id='quote'  value='"._MP_QUOTE."'>";
}
