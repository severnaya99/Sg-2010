<?php
/**
 * $Id: advanced_search_result.php 86 2006-01-21 16:14:28Z Michael $
...
**/
  ...
  $xoopsOption['template_main'] = 'advanced_search_result.html';
  ...
  $xoopsTpl->assign("site_image",tep_image(DIR_WS_IMAGES . 'table_background_browse.gif', HEADING_TITLE_2, HEADING_IMAGE_WIDTH, HEADING_IMAGE_HEIGHT));
  ...
  if ( ($customer_group->getdisplaytax() == '1') && (tep_not_null($pfrom) || tep_not_null($pto)) ) {
  ...
  $xoopsTpl->assign("adv_search_link",tep_href_link(FILENAME_ADVANCED_SEARCH, tep_get_all_get_params(array('sort', 'page')), 'NONSSL', true, false));
