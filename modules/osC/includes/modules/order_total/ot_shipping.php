<?php
/**
 * $Id: ot_shipping.php 58 2005-12-15 16:21:17Z Michael $
    ...
    function process() {
      ...
      if (tep_not_null($order->info['shipping_method'])) {
        if ($GLOBALS[$module]->tax_class > 0) {
          ...
          if ($customer_group->gettax() == '1') $order->info['shipping_cost'] += tep_calculate_tax($order->info['shipping_cost'], $shipping_tax);
        }
