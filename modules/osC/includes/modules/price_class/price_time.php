<?php
/**
 * $Id: price_time.php 65 2006-01-13 16:02:05Z Michael $
 * @package xosC
...
**/
  ...
  class price_time {
	var $code,$title,$description,$iterate;
...
**/
    function price_time() {
      ...
      $this->code = 'price_time';
      $this->title = MODULE_PRICE_CLASS_TIME_TITLE;
      $this->description = MODULE_PRICE_CLASS_TIME_DESCRIPTION;
      $this->iterate[]=array('id' => 1,'text' => MODULE_PRICE_CLASS_TIME_DAILY);
      $this->iterate[]=array('id' => 2,'text' => MODULE_PRICE_CLASS_TIME_WEEKLY);
      $this->iterate[]=array('id' => 3,'text' => MODULE_PRICE_CLASS_TIME_MONTHLY);
	  $this->iterate[]=array('id' => 4,'text' => MODULE_PRICE_CLASS_TIME_QUARTAL);
      $this->iterate[]=array('id' => 5,'text' => MODULE_PRICE_CLASS_TIME_YEARLY);
