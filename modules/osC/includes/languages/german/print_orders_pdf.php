...
define('TABLE_HEADING_PRICE_INCLUDING_TAX_UST', 'Einzelpreis');

define('TABLE_HEADING_TOTAL_EXCLUDING_TAX', 'Summe (exkl.)');
define('TABLE_HEADING_TOTAL_INCLUDING_TAX', 'Summe (inkl.)');

define('UST_FREI', 'Diese Rechnung bleibt gemδί § 19(1)UStG umsatzsteuerfrei.');
...
define('ENTRY_INVOICE_DATE_ZAHLBAR', 'Fδllig am:&nbsp;');
define('ENTRY_INVOICE_COSTUMER_ID', 'Kunden-Nr.:&nbsp;');
define('ENTRY_INVOICE_AUFTRAG_ID', 'Auftragsnummer:&nbsp;');
define('ENTRY_INVOICE_LIEFER_ID', 'Lieferscheinnummer:&nbsp;');


define('PRINT_INVOICE_HEADING', 'Bestellung');
define('PRINT_INVOICE_TITLE', 'Bestellung:&nbsp;');
define('PRINT_INVOICE_ORDERNR', 'Bestellnummer:&nbsp;');
define('PRINT_INVOICE_DATE', 'Bestelldatum:&nbsp;');
