<?php
/*
  $Id: filenames.php 57 2005-12-15 14:39:09Z Michael $
...
// define the filenames used in the project
  ...
  define('FILENAME_SHIPPING_HANDLING','shipping_handling.php');
  define('FILENAME_TERMS_OF_AGREEMENT','terms_of_agreement.php');
  define('FILENAME_TERMS_OF_REVOKE','terms_of_revoke.php'); 
  define('FILENAME_GV_FAQ','gv_faq.php');
  define('FILENAME_GV_REDEEM','gv_redeem.php');
  define('FILENAME_GV_SEND','gv_send.php');
   define('FILENAME_PRINT_ORDERS_PDF', 'print_orders_pdf.php');
?>
