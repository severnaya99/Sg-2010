...
// define the filenames used in the project
  ...
  define('FILENAME_CUSTOMER_GROUPS', 'customer_groups.php');
//Edit Invoice  
 define('FILENAME_EDIT_INVOICE', 'edit_invoice.php');
 define('FILENAME_EDIT_INVOICE_CONFIG', 'edit_invoice_config.php');
