<?php
/**
 * $Id: general.php 57 2005-12-15 14:39:09Z Michael $
...
// Text Mode
  ...
  function tep_get_category_short_description($category_id, $language_id) {
    $category_query = tep_db_query("select short_description from " . TABLE_CATEGORIES_DESCRIPTION . " where categories_id = '" . (int)$category_id . "' and language_id = '" . (int)$language_id . "'");
    $category = tep_db_fetch_array($category_query);
  ...
  function tep_get_products_short_description($product_id, $language_id) {
    $product_query = tep_db_query("select short_description from " . TABLE_PRODUCTS_DESCRIPTION . " where products_id = '" . (int)$product_id . "' and language_id = '" . (int)$language_id . "'");
    $product = tep_db_fetch_array($product_query);
...
// Function to read in text area in admin
 ...
 function tep_cfg_extended_textarea($configuration_id,$width,$height,$text) {
   return tep_draw_textarea_field($configuration_id, false, $width,$height, $text);
 }
