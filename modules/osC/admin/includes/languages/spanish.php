<?php
/*
  $Id: spanish.php 152 2006-02-06 12:19:54Z Michael $
...
define('ENTRY_GROUP_DESCRIPTION','Groupdescription');
define('ENTRY_GROUP_FSK18','FSK18 Products');
define('ENTRY_GROUP_TAX','mas IVA');
define('CATEGORY_SHIPPING','Shipping methods');
define('CATEGORY_PAYMENT','Paymentmethods');
define('YES','Yes');
define('NO','No');
define('ENTRY_GROUP_DISPLAY_TAX','Show IVA at products');
define('ENTRY_GROUP_DISPLAY_SHIPMENT','Show shipping costs');
define('TEXT_SHIPMENT_ALL','All Shippingmethods');
define('TEXT_PAYMENT_ALL','All payment methods');
