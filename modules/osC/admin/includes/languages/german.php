<?php
/*
  $Id: german.php 57 2005-12-15 14:39:09Z Michael $
...
define('BOX_GV_ADMIN_QUEUE', 'Uneingelöste Gutscheine');
define('BOX_GV_ADMIN_MAIL', 'Gutschein versenden');
...
define('TEXT_DISPLAY_NUMBER_OF_COUPONS', 'Zeige <b>%d</b> bis <b>%d</b> (von <b>%d</b> Coupons)');
...
define('TEXT_VALID_CATEGORIES_LIST', 'Kategorie List');
...
define('BOX_MODULES_PREOP','Bestellüberprüfung');
...
define('BOX_CUSTOMER_GROUPS','Kundengruppen');
...
define('BOX_HEADING_DISTRIBUTORS','Distributoren');
define('BOX_DISTRIBUTORS_DISTRIBUTORS','Distributoren');
...
define('CATEGORY_GROUP','Gruppe');
define('ENTRY_GROUP_NAME','Gruppenname');
define('ENTRY_GROUP_DESCRIPTION','Gruppenbeschreibung');
define('ENTRY_GROUP_FSK18','Zugang für FSK18 Produkte');
define('ENTRY_GROUP_TAX','Mehwertsteuer einberechnen');
define('CATEGORY_SHIPPING','Versandarten');
define('CATEGORY_PAYMENT','Zahlungsarten');
define('YES','Ja');
define('NO','Nein');
define('ENTRY_GROUP_DISPLAY_TAX','Steuer bei den Produkten anzeigen');
define('ENTRY_GROUP_DISPLAY_SHIPMENT','Versandkosten hinweis anzeigen');
define('TEXT_SHIPMENT_ALL','Alle installierten Versandarten');
define('TEXT_PAYMENT_ALL','Alle installierten Zahlungsarten');
// images
