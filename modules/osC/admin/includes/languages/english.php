<?php
/*
  $Id: english.php 57 2005-12-15 14:39:09Z Michael $
...
define('BOX_MODULES_PREOP','Pre order processing');
...
define('BOX_CUSTOMER_GROUPS','Customer Groups');
...
define('BOX_HEADING_DISTRIBUTORS','Distributors');
define('BOX_DISTRIBUTORS_DISTRIBUTORS','Distributors');
...
define('ENTRY_GROUP_NAME','Groupname');
define('ENTRY_GROUP_DESCRIPTION','Group description');
define('ENTRY_GROUP_FSK18','Right to buy FSK18 Products');
define('ENTRY_GROUP_TAX','Including VAT');
define('CATEGORY_SHIPPING','Allowed Shipping methohds');
define('CATEGORY_PAYMENT','Allowed Payment methods');
define('YES','Yes');
define('NO','No');
define('ENTRY_GROUP_DISPLAY_TAX','View products with tax info');
define('ENTRY_GROUP_DISPLAY_SHIPMENT','View products with shipping info');
define('TEXT_SHIPMENT_ALL','Use all installed shipping methods');
define('TEXT_PAYMENT_ALL','Use all installed payment methods');
// images
...
// Edit Invoice
define('BOX_HEADING_EDIT_INVOICE', 'Invoice-Editor');
define('BOX_TOOLS_EDIT_INVOICE', 'Invoice Text');
define('BOX_TOOLS_EDIT_INVOICE_CONFIG', 'Invoice Layout');
define('ICON_ORDERS_INVOICE', 'Word-Invoice');
define('ICON_ORDERS_PACKINGSLIP', 'Word-Packingslip');
?>
