...
define('TEXT_PRODUCTS_FSK18','Ist das Produkt FSK18 ?');
define('TEXT_EDIT_SHORT_DESCRIPTION','Kategorie kurzbeschreibung');
define('TEXT_CATEGORIES_STATUS','Kategorie Status');
define('ON','Online');
define('OFF','Offline');
...
define('TEXT_PRODUCTS_EAN','EAN Code');
define('TEXT_PRODUCTS_DISTRIBUTOR','Distributor');
define('TEXT_PRODUCTS_PRICE_CLASS','Preisklasse');
