...
/*===========================================================================*/
/*
  $Id: barcodegen.php 57 2005-12-15 14:39:09Z Michael $
  ...
  Released under the GNU General Public License
        ...
        $width          = (default=290) Width of image in pixels. The image MUST be wide
                                  enough to handle the length of the given value. The default
                                  value will probably be able to display about 11 digits. If you
...
if (empty ($text)) $text = BC_TEXTSHOW;
if (empty ($quality)) $quality = BC_QUALITY;
if (empty ($format)) $format = BC_OUTTYPE;
if (empty ($width)) $width = BC_WIDTH;
if (empty ($height)) $height = BC_HEIGHT;
$type = 1;
