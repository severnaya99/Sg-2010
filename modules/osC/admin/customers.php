<?php
/*
  $Id: customers.php 56 2005-12-09 15:10:01Z Michael $
  ...
  if (tep_not_null($action)) {
    switch ($action) {
      case 'update':
        ...
        $customers_group_id=tep_db_prepare_input($HTTP_POST_VARS['customer_group_id']);
      ...
      case 'deleteconfirm':
        ...
        break;
      default:
        $customers_query = tep_db_query("select c.customers_id, c.customers_gender, c.customers_firstname, c.customers_lastname, c.customers_group_id,c.customers_dob, c.customers_email_address, a.entry_company, a.entry_street_address, a.entry_suburb, a.entry_postcode, a.entry_city, a.entry_state, a.entry_zone_id, a.entry_country_id, c.customers_telephone, c.customers_fax, c.customers_newsletter, c.customers_default_address_id from " . TABLE_CUSTOMERS . " c left join " . TABLE_ADDRESS_BOOK . " a on c.customers_default_address_id = a.address_book_id where a.customers_id = c.customers_id and c.customers_id = '" . (int)$HTTP_GET_VARS['cID'] . "'");
...
?></td>
	  ...
	  <tr>
        <td class="formAreaTitle"><?php echo CATEGORY_CUSTOMER_GROUP; ?></td>
      </tr>

      <tr>
        <td class="formArea"><table border="0" cellspacing="2" cellpadding="2">
          <tr>
            <td class="main"><?php echo ENTRY_CUSTOMER_GROUP; ?></td>
            <td class="main">
<?php
  $customer_group_query=tep_db_query("select customer_group_id,customer_group_name from ".TABLE_CUSTOMER_GROUP);
  while($customer_group=tep_db_fetch_array($customer_group_query)) {
     $customer_group_array[]= array('id' => $customer_group['customer_group_id'], 'text' => $customer_group['customer_group_name']);
}
    echo tep_draw_pull_down_menu('customer_group_id', $customer_group_array, $cInfo->customers_group_id );
