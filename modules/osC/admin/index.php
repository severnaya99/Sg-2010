<?php
/**
 * $Id: index.php 48 2005-11-30 14:59:38Z Michael $
      ...
      <tr bgcolor="#000000">
        <td><table border="0" width="600" height="440" cellspacing="0" cellpadding="0">
          <tr bgcolor="#ffffff" height="50">
            <td height="50"><?php echo tep_image(DIR_WS_IMAGES . 'xosc-logo-wide.gif', 'xosC', '194', '54'); ?></td>
            <td align="right" class="text" nowrap><?php echo '<a href="' . tep_href_link(FILENAME_DEFAULT) . '">' . HEADER_TITLE_ADMINISTRATION . '</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a href="' . tep_catalog_href_link() . '">' . HEADER_TITLE_ONLINE_CATALOG . '</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a href="http://www.flinkux.de" target="_blank">' . HEADER_TITLE_SUPPORT_SITE . '</a>'; ?>&nbsp;&nbsp;</td>
          </tr>
          <tr bgcolor="#080381">
...
<?php
  ...
  $contents[] = array('params' => 'class="infoBox"',
                      'text'  => '<a href="http://www.flinkux.de" target="_blank">' . BOX_ENTRY_SUPPORT_SITE . '</a><br>' .
                                 '<a href="http://www.flinkux.de/modules/newbb/viewforum.php?forum=4" target="_blank">' . BOX_ENTRY_SUPPORT_FORUMS . '</a>' );
