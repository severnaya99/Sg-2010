<?php
/**
 * $Id: categories.php 62 2005-12-16 11:48:37Z Michael $
    ...
    switch ($action) {
      ...
      case 'update_category':
        ...
        for ($i=0, $n=sizeof($languages); $i<$n; $i++) {
		  ...
		  $categories_short_description_array= $HTTP_POST_VARS['short_description'];
          $language_id = $languages[$i]['id'];

          $sql_data_array = array('categories_name' => tep_db_prepare_input($categories_name_array[$language_id]),
		  					      'short_description' => tep_db_prepare_input($categories_short_description_array[$language_id]));
      ...
      case 'update_product':
        if (isset($HTTP_POST_VARS['edit_x']) || isset($HTTP_POST_VARS['edit_y'])) {
          ...
          $sql_data_array = array('products_quantity' => tep_db_prepare_input($HTTP_POST_VARS['products_quantity']),
								  ...
								  'products_fsk18' => tep_db_prepare_input($HTTP_POST_VARS['products_fsk18']),
                                  'manufacturers_id' => tep_db_prepare_input($HTTP_POST_VARS['manufacturers_id']),
								  'products_price_class' => tep_db_prepare_input($HTTP_POST_VARS['products_price_class']),
								  'products_ean' => tep_db_prepare_input($HTTP_POST_VARS['products_ean']),
								  'products_distributor_id' =>  tep_db_prepare_input($HTTP_POST_VARS['products_distributor_id']));
          ...
          for ($i=0, $n=sizeof($languages); $i<$n; $i++) {
            ...
            $sql_data_array = array('products_name' => tep_db_prepare_input($HTTP_POST_VARS['products_name'][$language_id]),
                                    ...
                                    'short_description' => tep_db_prepare_input($HTTP_POST_VARS['short_description'][$language_id]),
...
<?php
  if ($action == 'new_product') {
    $parameters = array('products_name' => '',
                       ...
                       'manufacturers_id' => '',
					   'products_fsk18' => '',
					   'products_price_class' => '',
					   'products_ean' => '',
					   'products_distributor_id' => '');
    ...
    $distributors_array = array(array('id' => '0', 'text' => TEXT_NONE));
    $distributors_query = tep_db_query("select distributor_id, distributor_name from " . TABLE_DISTRIBUTORS . " order by distributor_name");
    while ($distributor = tep_db_fetch_array($distributors_query)) {
      $distributors_array[] = array('id' => $distributor['distributor_id'],
      ...
      <tr>
        <td><table border="0" cellspacing="0" cellpadding="2">
          ...
          <tr>
            ...
            <td class="main"><?php echo tep_draw_separator('pixel_trans.gif', '24', '15') . '&nbsp;' . tep_draw_input_field('products_ean', $pInfo->products_ean, ''); ?></td>
          </tr>
          <tr>
            <td colspan="2"><?php echo tep_draw_separator('pixel_trans.gif', '1', '10'); ?></td>
          </tr>
          ...
          <tr>
            ...
            <td class="main"><?php echo tep_draw_separator('pixel_trans.gif', '24', '15') . '&nbsp;' . tep_draw_pull_down_menu('products_distributor_id', $distributors_array, $pInfo->products_distributor_id); ?></td>
          </tr>
          <tr>
            <td colspan="2"><?php echo tep_draw_separator('pixel_trans.gif', '1', '10'); ?></td>
          </tr>
...
?>
         ...
         <tr bgcolor="#ebebff">
            <td class="main"><?php echo TEXT_PRODUCTS_FSK18; ?></td>
<?php if($pInfo->products_fsk18 == 1 ) { $fsk18status=true;$fsk18nostatus=false; } else { $fsk18status=false;$fsk18nostatus=true;} ?>
            <td class="main"><?php echo tep_draw_separator('pixel_trans.gif', '24', '15') . '&nbsp;' . tep_draw_radio_field('products_fsk18',1,$fsk18status).YES.  tep_draw_radio_field('products_fsk18',0,$fsk18nostatus).NO ?></td>
          </tr>
<script type="text/javascript">
function alter_price_class() {
 document.new_product.action='<?php echo FILENAME_CATEGORIES."?cPath=".$cPath."&pID=".$_GET['pID']."&action=new_product"; ?>';
...
<?php
  $module_directory = DIR_FS_CATALOG_MODULES . 'price_class/';
  ...
  $price_class_array = array();
  for ($i=0, $n=sizeof($directory_array); $i<$n; $i++) {
    $file = $directory_array[$i];

    include(DIR_FS_CATALOG_LANGUAGES . $language . '/modules/price_class/' . $file);
	...
	if (tep_class_exists($class)) {
      $module = new $class;
      $price_class_array[]=array('id' => $module->code, 'text' => $module->title);
	}
  }
?>
          ...
          <tr bgcolor="#ebebff">
            <td class="main"><?php echo TEXT_PRODUCTS_PRICE_CLASS; ?></td>
            <td class="main"><?php echo tep_draw_separator('pixel_trans.gif', '24', '15') . '&nbsp;' . tep_draw_pull_down_menu('products_price_class',$price_class_array, $pInfo->products_price_class, 'onChange="alter_price_class()"'); ?></td>
          </tr>
<?php
   if(isset($pInfo->products_price_class) && !empty($pInfo->products_price_class) ) {
     $price_class = new $pInfo->products_price_class;
   } else {
     $price_class = new price_standard;
	}
   echo $price_class->getAdminPricing();
?>
<!--          <tr bgcolor="#ebebff">
...
<td class="main"><?php echo tep_draw_textarea_field('short_description[' . $languages[$i]['id'] . ']', 'soft', '70', '5', (isset($short_description[$languages[$i]['id']]) ? stripslashes($short_description[$languages[$i]['id']]) : tep_get_products_short_description($pInfo->products_id, $languages[$i]['id']))); ?></td>
              </tr>
...
<?php
    ...
    for ($i=0, $n=sizeof($languages); $i<$n; $i++) {
      if (isset($HTTP_GET_VARS['read']) && ($HTTP_GET_VARS['read'] == 'only')) {
		...
		$pInfo->short_description=tep_get_products_short_description($pInfo->products_id, $languages[$i]['id']);
...
?>
    <table border="0" width="100%" cellspacing="0" cellpadding="2">
      ...
      <tr>
        <td class="main"><?php echo tep_image(DIR_WS_CATALOG_IMAGES . $products_image_name, $pInfo->products_name, SMALL_IMAGE_WIDTH, SMALL_IMAGE_HEIGHT, 'align="right" hspace="5" vspace="5"') . $pInfo->short_description; ?></td>
      </tr>

      <tr>
        <td class="main"><?php echo $pInfo->products_description; ?></td>
      </tr>
<?php
...
/* Re-Post all POST'ed variables */
      ...
      for ($i=0, $n=sizeof($languages); $i<$n; $i++) {
        ...
        echo tep_draw_hidden_field('short_description[' . $languages[$i]['id'] . ']', htmlspecialchars(stripslashes($short_description[$languages[$i]['id']])));
...
<?php
    ...
    switch ($action) {
      case 'new_category':
        ...
        if($cInfo->categories_status == 1 ) { $online=true;$offline=false;}else{$online=false;$offline=true;}
