<?php
/**
 * $Id: shipping_handling.php 105 2006-01-21 16:15:16Z Michael $
...
**/
  ...
  $xoopsOption['template_main'] = 'shipping_handling.html';
  ...
  require(DIR_WS_LANGUAGES . $language . '/' . FILENAME_SHIPPING_HANDLING);
  $breadcrumb->add(NAVBAR_TITLE, tep_href_link(FILENAME_SHIPPING_HANDLING));
