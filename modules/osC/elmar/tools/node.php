...
// +----------------------------------------------------------------------+
//
// $Id: node.php 64 2005-12-19 18:07:20Z Michael $
//
...
class XML_Tree_Node {
    ...
    {
        // SK: Sonderfall \x0B -> Leerzeichen eingefügt und deutsche Sonderzeichen wegen ISO-8859-1 nicht konvertieren.
        $xml = str_replace(array("\x0B", /*'ü', 'Ü', 'ö',
                                 'Ö', 'ä', 'Ä',
                                 'ß',*/ '<', '>',
                                 '"', '\''
                                ),
