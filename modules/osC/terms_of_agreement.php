<?php
/**
 * $Id: terms_of_agreement.php 90 2006-01-21 16:14:36Z Michael $
...
**/
  ...
  $xoopsOption['template_main'] = 'terms_of_agreement.html';
  ...
  require(DIR_WS_LANGUAGES . $language . '/' . FILENAME_TERMS_OF_AGREEMENT);
  $breadcrumb->add(NAVBAR_TITLE, tep_href_link(FILENAME_TERMS_OF_AGREEMENT));
