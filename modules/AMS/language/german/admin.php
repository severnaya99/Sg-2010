...
define("_AMS_AM_DELETE","Löschen");
define("_AMS_AM_LAST10ARTS","Letzte %d Artikel");
define("_AMS_AM_PUBLISHED","Veröffentlicht"); // Veröffentlicht Datum
define("_AMS_AM_GO","Ausführen!");
define("_AMS_AM_EDITARTICLE","Bearbeite Artikel");
define("_AMS_AM_POSTNEWARTICLE","Schreibe neuen Artikel");
define("_AMS_AM_ARTPUBLISHED","Ihr Artikel wurde veröffentlicht!");
define("_AMS_AM_HELLO","Hallo %s,");
define("_AMS_AM_YOURARTPUB","Ihr eingeschickter Artikel wurde veröffentlicht.");
define("_AMS_AM_TITLEC","Titel: ");
define("_AMS_AM_URLC","URL: ");
define("_AMS_AM_PUBLISHEDC","Veröffentlicht: ");
define("_AMS_AM_RUSUREDEL","Sind Sie siecher, das Sie diesen Artikel und alle verbundenen Kommentare löschen wollen?");
...
define("_AMS_AM_CHANGEDATETIME","Datum/Zeit der Publikation verändern");
...
define("_AMS_AM_SETDATETIME","Setze Datum/Zeit der Veröffentlichung");
...
define("_AMS_AM_PUBINHOME","Auf der Startseite veröffentlichen?");
define("_AMS_AM_ADD","Hinzufügen");

//%%%%%%	Admin Module Name  Themas 	%%%%%

define("_AMS_AM_ADDMTOPIC","Ein HAUPT-Thema hinzufügen");
...
define("_AMS_AM_ADDSUBTOPIC","Ein SUB-Thema hinzufügen");
define("_AMS_AM_IN","in");
define("_AMS_AM_MODIFYTOPIC","Thema ändern");
define("_AMS_AM_MODIFY","Ändere");
define("_AMS_AM_PARENTTOPIC","Übergeordnetes Thema");
define("_AMS_AM_SAVECHANGE","Änderungen speichern");
define("_AMS_AM_DEL","Löschen");
define("_AMS_AM_CANCEL","Abbrechen");
define("_AMS_AM_WAYSYWTDTTAL","WARNUNG: Sind Sie sicher, das Sie dieses Thema und alle verbundenen Artikel und Kommentare löschen wollen?");
...
define("_AMS_AM_CHANGEEXPDATETIME","Ablaufdatum/Zeit ändern");
define("_AMS_AM_SETEXPDATETIME","Setze Datum/Zeit des Ablaufs");
define("_AMS_AM_NOWSETEXPTIME","Ist jetzt gesetzt auf: %s");

// Added in RC3
define("_AMS_AM_ERRORTOPICNAME", "Sie müssen einen Thema Namen eingeben!");
define("_AMS_AM_EMPTYNODELETE", "NIchts zu löschen!");

// Added 240304 (Mithrandir)
define("_AMS_AM_GROUPPERM", "Berechtigungen");
define("_AMS_AM_SELFILE","Wähle Datei");
...
define("_AMS_AM_SPOT_SHOWIMAGE_DESC", "Wähle ein Bild zum anzeigen, zeige das Themen Bild oder den Avatar des Verfassers");
