<?php
// $Id: schinese.php 331 2007-12-23 16:01:11Z malanciault $
//  ------------------------------------------------------------------------ //
...
// ------------------------------------------------------------------------- //
require SSECTION_FPDF_PATH.'/chinese.php';
...
define('SSECTION_PDF_FORUM', '论坛');
define('SSECTION_PDF_TOPIC', '主题');
define('SSECTION_PDF_SUBJECT', '标题');
define('SSECTION_PDF_AUTHOR', _POSTEDBY);
define('SSECTION_PDF_DATE', _MD_POSTEDON);
define('SSECTION_PDF_PAGE', '第%s页');
