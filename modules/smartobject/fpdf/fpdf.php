...
*                                                                              *
* 03/08/04 _parsegif() added by St@neCold, http://www.csgui.de                 *
* Function _parsegif() by Jérôme Fenal, require_once 'gif.php'                 *
...
function Image($file,$x,$y,$w=0,$h=0,$type='',$link='')
{
	...
	if(!isset($this->images[$file]))
	{
		...
		else
		{
			...
			$mtd='_parse'.$type;
			// Hack by marcan : original code was causing a fatal error on some unsupported image type
			/*
			...
			// end of Hack by marcan : original code was causing a fatal error on some unsupported image type
		}
		set_magic_quotes_runtime($mqr);
		$info['i']=count($this->images)+1;
		$info['w'] = ($info['w'])?$info['w']:1;
		$info['h'] = ($info['h'])?$info['h']:1;
