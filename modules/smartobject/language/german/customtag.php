...
define('_AM_SOBJECT_CUSTOMTAGS', 'Benutzerdefinierte Tags');
define('_AM_SOBJECT_CUSTOMTAGS_DSC', 'Here is a list of the custom tags available in the system.');
define('_AM_SOBJECT_CUSTOMTAG', 'Benutzerdefinierter Tag');
define('_AM_SOBJECT_CUSTOMTAGS_CREATE', 'Tag erstellen');
define('_AM_SOBJECT_CUSTOMTAG_CREATE', 'Tag erstellen');
...
define('_AM_SOBJECT_CUSTOMTAGS_EDIT', 'Tag bearbeiten');
...
define('_CO_SOBJECT_CUSTOMTAG_DESCRIPTION', 'Beschreibung');
