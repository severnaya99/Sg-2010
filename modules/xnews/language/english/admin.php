...
define("_AM_NW_GENERALSET", "Module Settings" );
...
define("_AM_NW_DESCRIPTION", "<H3>xNews is a clonable UTF-8 module</H3> 
							  where users can post news/comments. Cloning the module to multiple ones enable to have one only method for many different tasks. Other than usual news tasks it can be used for info, links and more all with their own blocks and menus and topics.");
?>
