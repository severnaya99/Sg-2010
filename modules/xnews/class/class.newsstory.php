	...
	*/
	...
	function imglink()
	{
		...
		if(xoops_trim($this->picture()) == '') {
			if ($this->topic_imgurl() != '' && file_exists(NW_TOPICS_FILES_PATH . '/'.$this->topic_imgurl())) {
				if ( $topic_display == 1 ) {
					if ( $seo_enabled == 1 ) {
						...
						$ret = "<a href='" . NW_MODULE_URL . "/articles.cat." . $this->topicid() . "/" . $cat_path . "'><img src='" . NW_TOPICS_FILES_URL . "/" . $this->topic_imgurl() . "' alt='" . $this->topic_title() . "' hspace='10' vspace='10' align='" . $this->topicalign() . "'" . $margin . " /></a>";
					} else {
						$ret = "<a href='" . NW_MODULE_URL . "/index.php?storytopic=" . $this->topicid() . "'><img src='" . NW_TOPICS_FILES_URL . "/" . $this->topic_imgurl() . "' alt='" . $this->topic_title() . "' hspace='10' vspace='10' align='" . $this->topicalign() . "'" .  $margin . " /></a>";
					}
				} else {
			...
			if ( $topic_display == 1 ) {
				if ( $seo_enabled == 1 ) {
					$cat_path = nw_remove_accents($this->topic_title());
					$ret = "<a href='" . NW_MODULE_URL . "/articles.cat." . $this->topicid() . "/" . $cat_path . "'><img src='" . NW_TOPICS_FILES_URL . "/" . $this->picture() . "' alt='" . $this->topic_title() . "' hspace='10' vspace='10' align='" . $this->topicalign() . "'" . $margin . " /></a>";
				} else {
					$ret = "<a href='" . NW_MODULE_URL . "/index.php?storytopic=" . $this->topicid() . "'><img src='" . NW_TOPICS_FILES_URL . "/" . $this->picture() . "' alt='" . $this->topic_title() . "' hspace='10' vspace='10' align='" . $this->topicalign() . "'" . $margin . " /></a>";
				}
		    } else {
	...
	function textlink()
	{
		...
		if ( $seo_enabled == 1 ) {
			if ( $topic_display == 1 ) {
				$cat_path = nw_remove_accents($this->topic_title());
				$ret = "<a href='" . NW_MODULE_URL . "/articles.cat." . $this->topicid() . "/" . $cat_path . "'>" . $this->topic_title() . "</a>";
			}
		}
		else {
			...
			$ret = '';
			if ( $topic_display == 1 ) {
				$ret = "<a href='" . NW_MODULE_URL . "/index.php?storytopic=" . $this->topicid() . "'>" . $this->topic_title() . "</a>";
			}
		}	
		return $ret;
	}
