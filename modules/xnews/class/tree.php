...
class nw_MyXoopsObjectTree {
	 ...
	 **/
	function nw_MyXoopsObjectTree(&$objectArr, $myId, $parentId, $rootId = null)
	{
	 ...
	 **/
	function makeSelBox($name, $fieldName, $prefix='-', $selected='', $addEmptyOption = false, $key=0, $additional='')
    {
