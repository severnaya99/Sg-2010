...
{ 
	...
	if ( !empty($_POST['clone_modulename']) )
	{
		...
		$patterns = array(	
			...
			'$modversion["name"] = "' . $old_modulename . '"' =>  '$modversion["name"] = "' . $new_modulename . '"',
...
function CloneNewsImport()
{
	...
	//Copy all images, attachments, topic icons to new uploads/mosulename dir
	//Topic icons
...
switch ($op) {
    ...
    default:
        ...
        echo "<b><a href='" . XOOPS_URL . "/modules/" . strtolower('xNews') . "/admin/index.php?op=cloner'><img  src='" . NW_MODULE_URL . "/images/cloner32.png' alt='' /><br/>" . _AM_NW_CLONER . "</a></b>\n";
