...
define("_ALBM_REDOTHUMBSNUMBER","Número thumbs por vez");
...
define("_ALBM_PHOTOTITLE","Títule");
...
define("_ALBM_FILEERROR","Foto não enviada ou a foto é muito grande");
...
define("_ALBM_COMMENTSDEL","Comentários Deletados com Sucesso!");

// End New

define("_ALBM_THANKSFORINFO","Obrigado pela informação. Estaremos verificando seu pedido em breve.");
...
define("_ALBM_TITLEATOZ","Títule (de A a Z)");
define("_ALBM_TITLEZTOA","Títule (de Z a A)");
...
define("_ALBM_RATINGSCALE","A escala é 1 - 10, com o 1 que é péssimo e 10 excelente.");
...
define("_ALBM_ALLPENDING","Todas as fotos enviadas estarão submitidas à um processo de validação.");
...
define("_ALBM_MUSTREGFIRST","Perdão, Você não tem permissão de acesso.<br>Por Favor, registre-se ou autentique-se primeiro!");
define("_ALBM_MUSTADDCATFIRST","Perdão, Você não uma categoria criada ainda.<br>Por Favor, crie uma categoria!");
...
define("_ALBM_CHECKCONFIGS","Verificar Configurações&Ambientes");
...
define("_ALBM_IMGURLMAIN","URL da Imagem(OPCIONAL e válido apenas para categorias gerais. A altura da imagem será redimensionada para 50): ");
