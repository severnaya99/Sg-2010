...
define( "_ALBM_GPERM_G_INSERTABLE" , "Envío (necesita aprobación)" ) ;
define( "_ALBM_GPERM_G_SUPERINSERT" , "Super Envío" ) ;
define( "_ALBM_GPERM_G_EDITABLE" , "Editar (necesita aprobación)" ) ;
define( "_ALBM_GPERM_G_SUPEREDIT" , "Super Editar" ) ;
define( "_ALBM_GPERM_G_DELETABLE" , "Borrado (necesita aprobación)" ) ;
...
define( "_ALBM_GPERM_G_RATEVIEW" , "Ver Ratio" ) ;
...
define( "_ALBM_CAPTION_IMAGEXYT" , "Tamaño(Tipo)" ) ;
