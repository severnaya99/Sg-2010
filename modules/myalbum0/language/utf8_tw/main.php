...
define("_ALBM_VALIDPHOTO","發佈");
define("_ALBM_PHOTODEL","刪除相片?");
define("_ALBM_DELETINGPHOTO","相片刪除中，請稍侯...");
define("_ALBM_MOVINGPHOTO","相片移動中，請稍侯...");

define("_ALBM_STORETIMESTAMP","請不要變更 timestamp");
...
define("_ALBM_LIDASC","紀錄編號 (由小至大)");
define("_ALBM_LIDDESC","紀錄編號 (由大至小)");
...
define("_ALBM_GROUPPERM_GLOBAL","全域權限");
define("_ALBM_CHECKCONFIGS","檢查組態與環境設定");
define("_ALBM_BATCHUPLOAD","相片批次上傳");
define("_ALBM_GENERALSET","偏好設定");
