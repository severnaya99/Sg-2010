<?php
// $Id: comment_reply.php,v 1.2 2005/09/01 13:58:32 mcleines Exp $
//  ------------------------------------------------------------------------ //
...
if (USER_CAN_POST_COMMENTS && $CURRENT_ALBUM_DATA['comments'] == 'YES') include XOOPS_ROOT_PATH.'/include/comment_reply.php';
