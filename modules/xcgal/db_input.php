<?php
// $Id: db_input.php,v 1.12 2006/10/02 12:07:08 mcleines Exp $
//  ------------------------------------------------------------------------ //
...
//
        ...
        $aid         = (int)$_POST['aid'];
        $title       = $myts->makeTboxData4Save(trim($_POST['title']));
...
//
        ...
        if (trim($title)=='') {
           $title = substr($myts->makeTboxData4Save($_FILES['userpicture']['name']), 0, (strlen($_FILES['userpicture']['name']) -4));
        }
        $caption  = $myts->makeTareaData4Save($_POST['caption'],0);
        $keywords = $myts->makeTboxData4Save($_POST['keywords']);
        $user1    = $myts->makeTboxData4Save($_POST['user1']);
        $user2    = $myts->makeTboxData4Save($_POST['user2']);
        $user3    = $myts->makeTboxData4Save($_POST['user3']);
        $user4    = $myts->makeTboxData4Save($_POST['user4']);
        ...
        $_FILES['userpicture']['name'] = $myts->makeTboxData4Save($_FILES['userpicture']['name']);
...
if($_FILES['userpicture1']['tmp_name'] != "") {
        ...
        $title    = $myts->makeTboxData4Save($_POST['title1']);
        if (trim($title)=='') {
           $title = $myts->makeTboxData4Save($_FILES['userpicture1']['name']);
        }
        ...
        // Check that the file uploaded has a valid extension
        $_FILES['userpicture1']['name'] = $myts->makeTboxData4Save($_FILES['userpicture1']['name']);
...
if($_FILES['userpicture2']['tmp_name'] != "") {
        $title    = $myts->makeTboxData4Save($_POST['title2']);
        if (trim($title)=='') {
           $title = $myts->makeTboxData4Save($_FILES['userpicture2']['name']);
        }
        ...
        // Check that the file uploaded has a valid extension
        $_FILES['userpicture2']['name'] = $myts->makeTboxData4Save($_FILES['userpicture2']['name']);
...
if($_FILES['userpicture3']['tmp_name'] != "") {
        $title    = $myts->makeTboxData4Save($_POST['title3']);
        if (trim($title)=='') {
           $title = $myts->makeTboxData4Save($_FILES['userpicture3']['name']);
        }
        ...
        // Check that the file uploaded has a valid extension
        $_FILES['userpicture3']['name'] = $myts->makeTboxData4Save($_FILES['userpicture3']['name']);
...
if($_FILES['userpicture4']['tmp_name'] != "") {
        $title    = $myts->makeTboxData4Save($_POST['title4']);
        if (trim($title)=='') {
           $title = $myts->makeTboxData4Save($_FILES['userpicture4']['name']);
        }
        ...
        // Check that the file uploaded has a valid extension
        $_FILES['userpicture4']['name'] = $myts->makeTboxData4Save($_FILES['userpicture4']['name']);
