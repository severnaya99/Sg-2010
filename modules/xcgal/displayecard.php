<?php
// $Id: displayecard.php,v 1.3 2005/09/07 11:03:00 mcleines Exp $         edit: cm 07082005
//  ------------------------------------------------------------------------ //
...
$xoopsTpl->assign('ecard_title', sprintf(_MD_CARD_ECARD_TITLE, $myts->makeTboxData4Show($row['sender_name'])));
...
$xoopsTpl->assign('sender_email',$myts->makeTboxData4Show($row['sender_email']));
$xoopsTpl->assign('sender_name',$myts->makeTboxData4Show($row['sender_name']));
