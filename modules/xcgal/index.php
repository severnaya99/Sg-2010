<?php
// $Id: index.php,v 1.3 2005/09/07 11:03:00 mcleines Exp $
//  ------------------------------------------------------------------------ //
    ...
    global $xoopsModuleConfig, $HIDE_USER_CAT, $xoopsDB, $myts;
        ...
        if ($xoopsDB->getRowsNum($sql) > 0){
                ...
                $xoopsDB->freeRecordSet($result);
                                ...
                                $link = $ident."<a href=index.php?cat={$subcat['cid']}>".$myts->makeTboxData4Show($subcat['name'])."</a>";
                                if($album_count){
                ...
                $xoopsDB->freeRecordSet($result);
                                ...
                                $subcat['name'] = $myts->makeTboxData4Show($subcat['name']);
                                $subcat['description'] = preg_replace("/<br \/>/i",'<br />'.$ident ,$myts->makeTareaData4Show($subcat['description']));
