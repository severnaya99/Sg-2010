...
define("_MD_ORPHAN_CAT","A category has a non-existing parent, runs the category manager to correct the problem.");
...
define("_MD_THM_LAST_UPL","Last uploads");
define("_MD_THM_LAST_COM","Last comments");
