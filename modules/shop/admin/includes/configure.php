...
// Define the webserver and path parameters
  ...
  define('HTTPS_CATALOG_SERVER', str_replace('http','https',HTTP_SERVER));
...
// * DIR_WS_* = Webserver directories (virtual/URL)
  ...
  define('DIR_WS_ADMIN', NXOOPS_URL.'/modules/shop/admin/');
  
  define('DIR_WS_CATALOG', NXOOPS_URL.'/modules/shop/');
  define('DIR_WS_HTTPS_ADMIN', NXOOPS_URL.'/modules/shop/admin/');
...
// * DIR_FS_* = Filesystem directories (local/physical)
  ...
  define('DIR_FS_ADMIN', XOOPS_ROOT_PATH.'/modules/shop/admin/');
  ...
  define('DIR_FS_FILE_MANAGER_ROOT', XOOPS_ROOT_PATH.'/modules/shop'); // path to starting directory of the file manager
