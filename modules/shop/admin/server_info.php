...
// +----------------------------------------------------------------------+
//  $Id: server_info.php 364 2004-09-29 05:59:45Z drbyte $
//
...
hr {display: none; font-size: 11px;}
    ...
    echo '<table width="600" border="1" cellpadding="3" style="border: 0px; border-color: #000000;">' .
...
// @TODO: add version-history listing here...
         '</td>' .
         '  </tr>' .
         '</table>';
    echo $regs[1];
