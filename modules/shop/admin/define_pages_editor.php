...
// +----------------------------------------------------------------------+
//  $Id: define_pages_editor.php 1592 2005-07-15 20:08:03Z ajeh $
//
...
?>
          ...
          <tr>
            <td align="right"><?php echo '<a href="' . zen_href_link(FILENAME_FILE_MANAGER, 'current_path=' . DIR_FS_CATALOG_LANGUAGES . $_SESSION['language']) . '">' . zen_image_button('button_file_manager.gif', IMAGE_FILE_MANAGER) . '</a>'; ?></td>
          </tr>
<?php
  }
?>
