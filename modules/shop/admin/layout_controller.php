...
<!-- body_text //-->
    <td width="100%" valign="top"><table border="0" width="100%" cellspacing="0" cellpadding="2">
      ...
      <tr>
        <td><table border="0" width="100%" cellspacing="0" cellpadding="0"><tr><td><br/><br/>
		<table border="0" width="100%" cellspacing="0" cellpadding="0"><th colspan="4" class="headerBarContent" style="background-color:#C96E29">Rebuild Blocks</th>
<?php
...
$languages_query_raw = "select languages_id, name, code, image, directory, sort_order from " . TABLE_LANGUAGES . " order by sort_order";
  ...
  while (!$languages->EOF) {
	...
	echo '<td class="dataTableContent"><a href="'.DIR_WS_CATALOG.'buildcache.php?lang='. $languages->fields['name'] .'" target="_blank">Rebuild Blocks</a></td>';
?>
