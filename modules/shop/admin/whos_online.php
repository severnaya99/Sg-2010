...
// +----------------------------------------------------------------------+
//  $Id: whos_online.php 1094 2005-03-29 16:10:03Z ajeh $
//
      ...
      <tr>
        <td><table border="0" width="100%" cellspacing="0" cellpadding="0">
          ...
          <tr>
            ...
            <?php echo
              '<a href="' . zen_href_link(FILENAME_WHOS_ONLINE . '.php' . '?listing=' . $listing) . '" class="menuBoxContentLink">' .
          ...
          <tr>
            <td valign="top"><table border="0" width="100%" cellspacing="0" cellpadding="2">
              <tr class="dataTableHeadingRowWhois">
                ...
                <td class="dataTableHeadingContentWhois"><?php echo TABLE_HEADING_FULL_NAME; ?></td>
...
?>
                <td class="dataTableContentWhois" colspan=3 valign="top">&nbsp;&nbsp;&nbsp;&nbsp;Last Clicked: <?php echo zen_check_minutes($whos_online->fields['time_last_click']); ?> ago</td>
                <td class="dataTableContentWhois" colspan=4 valign="top">Host: <?php echo $whos_online->fields['host_address'] . '<br />' . 'User Agent: ' . $whos_online->fields['user_agent']; ?></td>
...
?>
              <tr>
               <td colspan="2"><?php echo zen_draw_separator('pixel_trans.gif', '1', '2'); ?></td>
              </tr>
...
?>
              <tr>
                <td class="smallText" colspan="7">Legend: <?php echo zen_image(DIR_WS_IMAGES . 'icon_status_green.gif') . " Active cart &nbsp;&nbsp;" . zen_image(DIR_WS_IMAGES . 'icon_status_yellow.gif') . " Inactive cart &nbsp;&nbsp;" . zen_image(DIR_WS_IMAGES . 'icon_status_red.gif') . " Active no cart &nbsp;&nbsp;" .  zen_image(DIR_WS_IMAGES . 'icon_status_red_light.gif') . " Inactive no cart " . "<br>Inactive is Last Click >= " . WHOIS_TIMER_INACTIVE . "s" . " &nbsp; || Inactive since arrival > " . WHOIS_TIMER_DEAD . "s will be removed";?></td>
              </tr>
<?php
  }
?>
              <tr>
                <td class="smallText" colspan="7"><?php echo sprintf(TEXT_NUMBER_OF_CUSTOMERS, $total_sess); print "<br>Duplicate IP Addresses: $total_dupes<br>Total Unique Users: $total_cust.";?></td>
              </tr>
            </table></td>
<?php
  $heading = array();
