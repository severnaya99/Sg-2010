...
// +----------------------------------------------------------------------+
// $Id: header_php.php 1350 2005-05-09 07:29:33Z drbyte $
//
...
$is_upgrade = $_GET['is_upgrade'];
  ...
  if (isset($_POST['submit'])) {
    ...
    if (!$zc_install->fatal_error) {
      ...
      if ($is_upgrade && !$zc_install->fatal_error) { //if upgrading, move onto the upgrade page
         ...
         exit;
      } elseif (!$zc_install->fatal_error) { // not upgrading - load the fresh database
