...
// +----------------------------------------------------------------------+
// $Id: gv_send.php 1838 2005-08-13 05:01:03Z ajeh $
//
...
define('MAIN_MESSAGE', 'You have decided to post a ' . TEXT_GV_NAME . ' worth %s to %s whose email address is %s<br /><br />The text accompanying the email will read<br /><br />Dear %s<br /><br />' .
