...
// +----------------------------------------------------------------------+
// $Id: meta_tags.php 1670 2005-07-30 21:56:49Z ajeh $
//
...
// custom meta tags per product
      if (!empty($product_info_metatags->fields['metatags_keywords']) or !empty($product_info_metatags->fields['metatags_description'])) {
        ...
        define('META_TAG_KEYWORDS', $metatags_keywords);  // KEYWORDS and CUSTOM_KEYWORDS are added above
        ...
        define('META_TAG_KEYWORDS', $meta_products_name . ' ' . KEYWORDS);
