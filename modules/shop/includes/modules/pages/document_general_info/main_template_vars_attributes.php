...
// +----------------------------------------------------------------------+
// $Id: main_template_vars_attributes.php 1779 2005-08-07 17:40:04Z ajeh $
//
//////////////////////////////////////////////////
//// BOF: attributes
//////////////////////////////////////////////////
...
*/
        ...
        while (!$products_options->EOF) {
          ...
          if (((CUSTOMERS_APPROVAL == '2' and $_SESSION['customer_id'] == '') or (STORE_STATUS == '1')) or ((CUSTOMERS_APPROVAL_AUTHORIZATION == 1 or CUSTOMERS_APPROVAL_AUTHORIZATION == 2) and $_SESSION['customers_authorization'] == '')) {
            $new_attributes_price = '';
...
// collect weight information if it exists
          if ((SHOW_DOCUMENT_GENERAL_INFO_WEIGHT_ATTRIBUTES=='1' and $products_options->fields['products_attributes_weight'] != '0')) {
