...
// +----------------------------------------------------------------------+
// $Id: tpl_product_music_info_display.php 889 2005-01-05 17:55:06Z ajeh $
//
...
if ($debug_on == '1') {
  ...
  echo '<br> Start of page - product music <br>' .
  ...
  SHOW_PRODUCT_MUSIC_INFO_WEIGHT_ATTRIBUTES . '<br>' .
  SHOW_PRODUCT_MUSIC_INFO_WEIGHT . '<br>' .
  SHOW_PRODUCT_MUSIC_INFO_MANUFACTURER . '<br>' .
  SHOW_PRODUCT_MUSIC_INFO_QUANTITY . '<br>' .
  '<br />';
  echo '  </td>';
  echo '</tr>';
}
...
// base price
  ...
  echo $one_time . ((zen_has_product_attributes_values((int)$_GET['products_id']) and SHOW_PRODUCT_MUSIC_INFO_STARTING_AT == '1') ? TEXT_BASE_PRICE : '') . zen_get_products_display_price((int)$_GET['products_id']);
?>
    </td>
  </tr>
  ...
  <tr>
    <td class="main" align="center" valign="top">
      <?php echo ((SHOW_PRODUCT_MUSIC_INFO_GENRE == '1' and !empty($products_music_genre_name)) ? TEXT_PRODUCT_MUSIC_GENRE . $products_music_genre_name : '&nbsp;'); ?>
    </td>
  </tr>
  <tr>
    <td class="main" align="center" valign="top">
      <?php echo ((SHOW_PRODUCT_MUSIC_INFO_MODEL == '1' and $products_model !='') ? TEXT_PRODUCT_MODEL . $products_model : '&nbsp;'); ?>
    </td>
  </tr>
  <tr>
    <td class="main" align="center"><?php echo ((SHOW_PRODUCT_MUSIC_INFO_WEIGHT == '1' and $products_weight !=0) ? TEXT_PRODUCT_WEIGHT .  $products_weight . TEXT_PRODUCT_WEIGHT_UNIT : '&nbsp;'); ?></td>
  </tr>
  <tr>
...
?>
  ...
  <tr>
    <td >&nbsp;</td>
    <td class="main" align="center"><?php echo ((SHOW_PRODUCT_MUSIC_INFO_QUANTITY == '1') ? $products_quantity . TEXT_PRODUCT_QUANTITY : '&nbsp;'); ?></td>
  </tr>
  <tr>
    <td align="center"></td>
    <td align="center">
      ...
      <table border="0" width="150px" cellspacing="2" cellpadding="2">
        <tr>
          <td align="center" class="cartBox">
            <?php echo ((SHOW_PRODUCT_MUSIC_INFO_IN_CART_QTY == '1' and $_SESSION['cart']->in_cart($_GET['products_id'])) ? PRODUCTS_ORDER_QTY_TEXT_IN_CART . $_SESSION['cart']->get_quantity($_GET['products_id']) . '<br /><br />' : '&nbsp;'); ?>
            <?php
...
<?php
  if ($reviews->fields['count'] > 0 or SHOW_PRODUCT_MUSIC_INFO_REVIEWS == '1') {
    echo '<table align="left">';
    echo '  <tr>';
    echo '    <td class="main" align="center" valign="bottom">';
    echo (SHOW_PRODUCT_MUSIC_INFO_REVIEWS_COUNT == '1' ? TEXT_CURRENT_REVIEWS . ' ' . $reviews->fields['count'] : '&nbsp;') . '<br />';
    echo (SHOW_PRODUCT_MUSIC_INFO_REVIEWS == '1' ? '<a href="' . zen_href_link(FILENAME_PRODUCT_REVIEWS, zen_get_all_get_params()) . '">' . zen_image_button(BUTTON_IMAGE_REVIEWS, BUTTON_REVIEWS_ALT) . '</a>' : '&nbsp;');
    echo '    </td>';
    echo '  </tr>';
    echo '</table>';
  }
...
<?php
  if (SHOW_PRODUCT_MUSIC_INFO_TELL_A_FRIEND == '1') {
    echo '<table align="right">';
    echo '  <tr>';
    echo '    <td class="main" align="center" valign="bottom">';
    echo (SHOW_PRODUCT_MUSIC_INFO_TELL_A_FRIEND == '1' ? '<a href="' . zen_href_link(FILENAME_TELL_A_FRIEND, 'products_id=' . $_GET['products_id']) . '">' . zen_image_button(BUTTON_IMAGE_TELLAFRIEND, BUTTON_TELLAFRIEND_ALT) . '</a>' : '');
    echo '    </td>';
    echo '  </tr>';
    echo '</table>';
  }
...
<?php
  if ($products_date_available > date('Y-m-d H:i:s')) {
    if (SHOW_PRODUCT_MUSIC_INFO_DATE_AVAILABLE == '1') {
?>
  <tr>
...
<?php
    ...
    if (SHOW_PRODUCT_MUSIC_INFO_DATE_ADDED == '1') {
?>
  <tr>
