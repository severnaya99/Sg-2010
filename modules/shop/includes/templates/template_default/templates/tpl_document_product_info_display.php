...
// +----------------------------------------------------------------------+
// $Id: tpl_document_product_info_display.php 889 2005-01-05 17:55:06Z ajeh $
//
...
if ($debug_on == '1') {
  ...
  echo '<br /> Start of page - document product <br />' .
  ...
  SHOW_DOCUMENT_PRODUCT_INFO_WEIGHT_ATTRIBUTES . '<br />' .
  SHOW_DOCUMENT_PRODUCT_INFO_WEIGHT . '<br />' .
  SHOW_DOCUMENT_PRODUCT_INFO_MANUFACTURER . '<br />' .
  SHOW_DOCUMENT_PRODUCT_INFO_QUANTITY . '<br />' .
  '<br />';
  echo '  </td>';
  echo '</tr>';
}
