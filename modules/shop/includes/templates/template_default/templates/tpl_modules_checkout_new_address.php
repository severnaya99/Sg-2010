...
// +----------------------------------------------------------------------+
// $Id: tpl_modules_checkout_new_address.php 290 2004-09-15 19:48:26Z wilt $
//
?>
...
?>
  ...
  <tr>
    ...
    <td class="main"><?php echo zen_get_country_list('country', $entry['entry_country_id']) . '&nbsp;' . (zen_not_null(ENTRY_COUNTRY_TEXT) ? '<span class="inputRequirement">' . ENTRY_COUNTRY_TEXT . '</span>': ''); ?></td>
  </tr>
<?php
