...
// +----------------------------------------------------------------------+
// $Id: tpl_login_default.php 958 2005-01-24 17:03:11Z ajeh $
//
?>
    ...
    <td class="plainBox">
      <table border="0" width="100%" cellspacing="0" cellpadding="2">
        <tr>
          ...
          <td class="main">
            <?php echo zen_draw_input_field('email_address', $xoopsUser->getVar("email"), zen_set_field_length(TABLE_CUSTOMERS, 'customers_email_address', '40')); ?>
          </td>
        </tr>
        <tr>
...
?>
        <tr>
          ...
          <td class="main"><?php echo zen_draw_input_field('firstname', $xoopsUser->getVar("name"), zen_set_field_length(TABLE_CUSTOMERS, 'customers_firstname', '40')) . '&nbsp;' . (zen_not_null(ENTRY_FIRST_NAME_TEXT) ? '<span class="inputRequirement">' . ENTRY_FIRST_NAME_TEXT . '</span>': ''); ?></td>
        </tr>
        <tr>
...
?>
        <tr>
          <td class="main"><?php echo ENTRY_EMAIL_ADDRESS; ?></td>
          <td class="main"><?php echo zen_draw_input_field('email_address', $xoopsUser->getVar("email"), zen_set_field_length(TABLE_CUSTOMERS, 'customers_email_address', '40')) . '&nbsp;' . (zen_not_null(ENTRY_EMAIL_ADDRESS_TEXT) ? '<span class="inputRequirement">' . ENTRY_EMAIL_ADDRESS_TEXT . '</span>': ''); ?></td>
        </tr>
<?php
