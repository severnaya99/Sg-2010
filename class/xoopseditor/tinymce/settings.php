 ...
 * @version         $Id: settings.php 3440 2009-08-12 21:30:42Z luciorota $
 */
...
return array(
    ...
    "theme_advanced_buttons1" => "bold,italic,underline,strikethrough,sub,sup,separator,justifyleft,justifycenter,justifyright,justifyfull,formatselect,fontselect,fontsizeselect",
    "theme_advanced_buttons2" => "bullist,numlist,separator,outdent,indent,separator,undo,redo,removeformat,separator,link,unlink,anchor,image,media,separator,charmap,nonbreaking,hr,emotions,separator,pastetext,pasteword,separator,forecolor,backcolor",
    "theme_advanced_buttons3" => "tablecontrols,separator,cleanup,visualaid,visualchars,separator,insertdate,inserttime,separator,preview,fullscreen,help,code",
